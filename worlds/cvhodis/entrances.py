...
class CVHoDisTransitionData(NamedTuple):
    area_id: int  # ID for which area the transition is in.
    room_id: int  # ID for which room in the area the transition is in.
    zone_id: int  # ID for which loading zone in the area's room is associated with the transition.
    ...
    player_arrive_y_pos: int  # The on-screen standing Y position the player should be moved to upon arriving at the
                              # exit transition. This should only be different from the departure value if it's a
                              # vertical transition.
...
SHUFFLEABLE_TRANSITIONS: dict[str, CVHoDisTransitionData] = {
    ent_names.eta_exit_saa:   CVHoDisTransitionData(Areas.ENTRANCE_A, 0x0C, 3, ERGroups.RIGHT_A, 0x67, 0x67,
                                                    ent_names.saa_exit_eta, ent_names.etb_exit_sab,
                                                    AreaNames.ENTRANCE, TransitionNames.ET_SA, True),
    ent_names.eta_exit_mca:   CVHoDisTransitionData(Areas.ENTRANCE_A, 0x06, 3, ERGroups.RIGHT_A, 0x67, 0x67,
                                                    ent_names.mca_exit_eta, ent_names.etb_exit_mcb,
                                                    AreaNames.ENTRANCE, TransitionNames.ET_MC, True),
    ent_names.eta_exit_sca:   CVHoDisTransitionData(Areas.ENTRANCE_A, 0x0D, 4, ERGroups.BOTTOM_A, 0xA3, 0x8F,
                                                    ent_names.sca_exit_eta, ent_names.etb_exit_scb,
                                                    AreaNames.ENTRANCE, TransitionNames.ET_SC, False),
    ent_names.mca_exit_eta:   CVHoDisTransitionData(Areas.MARBLE_A, 0x00, 0, ERGroups.LEFT_A, 0x67, 0x67,
                                                    ent_names.eta_exit_mca, ent_names.mcb_exit_etb,
    ...
    ent_names.mca_exit_ria_l: CVHoDisTransitionData(Areas.MARBLE_A, 0x0E, 2, ERGroups.LEFT_A, 0x67, 0x67,
                                                    ent_names.ria_exit_mca_l, ent_names.mcb_exit_rib_l,
                                                    AreaNames.MARBLE, TransitionNames.MC_RI_L, False),
    ent_names.mca_exit_ria_r: CVHoDisTransitionData(Areas.MARBLE_A, 0x0E, 1, ERGroups.RIGHT_A, 0x67, 0x67,
                                                    ent_names.ria_exit_mca_r, ent_names.mcb_exit_rib_r,
                                                    AreaNames.MARBLE, TransitionNames.MC_RI_R, False),
    ent_names.mca_exit_wwa:   CVHoDisTransitionData(Areas.MARBLE_A, 0x0D, 1, ERGroups.RIGHT_A, 0x67, 0x67,
                                                    ent_names.wwa_exit_mca, ent_names.mcb_exit_wwb,
                                                    AreaNames.MARBLE, TransitionNames.MC_WW, True),
    ent_names.mca_exit_tfa:   CVHoDisTransitionData(Areas.MARBLE_A, 0x0C, 1, ERGroups.RIGHT_SKULL_A, 0x67, 0x67,
                                                    tfa_exit_mca, ent_names.mcb_exit_tfb,
                                                    AreaNames.MARBLE, TransitionNames.MC_TF, True),
    ent_names.ria_exit_mca_l: CVHoDisTransitionData(Areas.MARBLE_A, 0x0F, 0, ERGroups.RIGHT_A, 0x67, 0x67,
                                                    ent_names.mca_exit_ria_l, ent_names.rib_exit_mcb_l,
                                                    AreaNames.ROOM, TransitionNames.MC_RI_L, False),
    ent_names.ria_exit_mca_r: CVHoDisTransitionData(Areas.MARBLE_A, 0x10, 0, ERGroups.LEFT_A, 0x67, 0x67,
                                                    ent_names.mca_exit_ria_r, ent_names.rib_exit_mcb_r,
                                                    AreaNames.ROOM, TransitionNames.MC_RI_R, False),
    ent_names.wwa_exit_mca:   CVHoDisTransitionData(Areas.SHRINE_A, 0x02, 0, ERGroups.LEFT_A, 0x67, 0x67,
                                                    ent_names.mca_exit_wwa, ent_names.wwb_exit_mcb,
                                                    AreaNames.WAILING, TransitionNames.MC_WW, True),
    ent_names.wwa_exit_cya:   CVHoDisTransitionData(Areas.SHRINE_A, 0x08, 1, ERGroups.RIGHT_SKULL_A, 0x67, 0x67,
                                                    ent_names.cya_exit_wwa, ent_names.wwb_exit_cyb,
                                                    AreaNames.WAILING, TransitionNames.WW_CY, True),
    ent_names.wwa_exit_saa:   CVHoDisTransitionData(Areas.SHRINE_A, 0x09, 1, ERGroups.RIGHT_A, 0x67, 0x67,
                                                    ent_names.saa_exit_wwa, ent_names.wwb_exit_sab,
                                                    AreaNames.WAILING, TransitionNames.WW_SA, False),
    ent_names.saa_exit_wwa:   CVHoDisTransitionData(Areas.SHRINE_A, 0x0A, 1, ERGroups.LEFT_A, 0x67, 0x67,
                                                    ent_names.wwa_exit_saa, ent_names.sab_exit_wwb,
                                                    AreaNames.SHRINE, TransitionNames.WW_SA, False),
    ent_names.saa_exit_eta:   CVHoDisTransitionData(Areas.SHRINE_A, 0x0F, 0, ERGroups.LEFT_A, 0x67, 0x67,
                                                    ent_names.eta_exit_saa, ent_names.sab_exit_etb,
                                                    AreaNames.SHRINE, TransitionNames.ET_SA, True),
    ent_names.cya_exit_sca:   CVHoDisTransitionData(Areas.TREASURY_A, 0x0F, 0, ERGroups.LEFT_A, 0x67, 0x67,
                                                    ent_names.sca_exit_cya, ent_names.cyb_exit_scb,
                                                    AreaNames.TREASURY, TransitionNames.CY_SC, True),
    ent_names.cya_exit_lca:   CVHoDisTransitionData(Areas.TREASURY_A, 0x0E, 0, ERGroups.RIGHT_A, 0x67, 0x67,
                                                    ent_names.lca_exit_cya, ent_names.cyb_exit_lcb,
                                                    AreaNames.TREASURY, TransitionNames.CY_LC, True),
    ent_names.cya_exit_wwa:   CVHoDisTransitionData(Areas.TREASURY_A, 0x15, 0, ERGroups.LEFT_SKULL_A, 0x67, 0x67,
                                                    ent_names.wwa_exit_cya, ent_names.cyb_exit_wwb,
                                                    AreaNames.TREASURY, TransitionNames.WW_CY, True),
    ent_names.cya_exit_tfa:   CVHoDisTransitionData(Areas.TREASURY_A, 0x15, 1, ERGroups.TOP_A, 0x9F, 0x1F,
                                                    ent_names.tfa_exit_cya, ent_names.cyb_exit_tfb,
                                                    AreaNames.TREASURY, TransitionNames.CY_TF, False),
    ent_names.sca_exit_cya:   CVHoDisTransitionData(Areas.SKELETON_A, 0x00, 1, ERGroups.RIGHT_A, 0x67, 0x67,
                                                    ent_names.cya_exit_sca, ent_names.scb_exit_cyb,
                                                    AreaNames.SKELETON, TransitionNames.CY_SC, True),
    ent_names.sca_exit_eta:   CVHoDisTransitionData(Areas.SKELETON_A, 0x0D, 0, ERGroups.TOP_A, 0x9F, 0x1F,
                                                    ent_names.eta_exit_sca, ent_names.scb_exit_etb,
                                                    AreaNames.SKELETON, TransitionNames.ET_SC, False),
    ent_names.lca_exit_cya:   CVHoDisTransitionData(Areas.LUMINOUS_A, 0x00, 1, ERGroups.LEFT_A, 0x67, 0x67,
                                                    ent_names.cya_exit_lca, ent_names.lcb_exit_cyb,
                                                    AreaNames.LUMINOUS, TransitionNames.CY_LC, True),
    ent_names.lca_exit_ada:   CVHoDisTransitionData(Areas.LUMINOUS_A, 0x04, 1, ERGroups.RIGHT_A, 0x67, 0x67,
                                                    ent_names.ada_exit_lca, ent_names.lcb_exit_adb,
                                                    AreaNames.LUMINOUS, TransitionNames.LC_AD, True),
    ent_names.swa_exit_cda:   CVHoDisTransitionData(Areas.CHAPEL_A, 0x06, 0, ERGroups.LEFT_A, 0x7F, 0x7F,
                                                    ent_names.cda_exit_swa, ent_names.swb_exit_cdb,
                                                    AreaNames.WALKWAY, TransitionNames.SW_CD, False),
    ent_names.swa_exit_cra:   CVHoDisTransitionData(Areas.CHAPEL_A, 0x0E, 1, ERGroups.RIGHT_A, 0x67, 0x67,
                                                    ent_names.cra_exit_swa, ent_names.swb_exit_crb,
                                                    AreaNames.WALKWAY, TransitionNames.SW_CR, True),
    ent_names.swa_exit_ada:   CVHoDisTransitionData(Areas.CHAPEL_A, 0x12, 0, ERGroups.LEFT_A, 0x67, 0x67,
                                                    ent_names.ada_exit_swa, ent_names.swb_exit_adb,
                                                    AreaNames.WALKWAY, TransitionNames.SW_AD, True),
    ent_names.cda_exit_swa:   CVHoDisTransitionData(Areas.CHAPEL_A, 0x05, 1, ERGroups.RIGHT_A, 0x7F, 0x7F,
                                                    ent_names.swa_exit_cda, ent_names.cdb_exit_swb,
                                                    AreaNames.CHAPEL, TransitionNames.SW_CD, False),
    ent_names.cda_exit_tfa:   CVHoDisTransitionData(Areas.CHAPEL_A, 0x00, 0, ERGroups.LEFT_MK_A, 0x67, 0x67,
                                                    ent_names.tfa_exit_cda, ent_names.cdb_exit_tfb,
                                                    AreaNames.CHAPEL, TransitionNames.CD_TF, True),
    ent_names.ada_exit_swa:   CVHoDisTransitionData(Areas.AQUEDUCT_A, 0x06, 1, ERGroups.RIGHT_A, 0x67, 0x67,
                                                    ent_names.swa_exit_ada, ent_names.adb_exit_swb,
                                                    AreaNames.AQUEDUCT, TransitionNames.SW_AD, True),
    ent_names.ada_exit_lca:   CVHoDisTransitionData(Areas.AQUEDUCT_A, 0x00, 0, ERGroups.LEFT_A, 0x67, 0x67,
                                                    ent_names.lca_exit_ada, ent_names.adb_exit_lcb,
                                                    AreaNames.AQUEDUCT, TransitionNames.LC_AD, True),
    ent_names.ada_exit_cra:   CVHoDisTransitionData(Areas.AQUEDUCT_A, 0x0A, 1, ERGroups.RIGHT_A, 0x8F, 0x8F,
                                                    ent_names.cra_exit_ada, ent_names.adb_exit_crb,
                                                    AreaNames.AQUEDUCT, TransitionNames.AD_CR, True),
    ent_names.cra_exit_ada:   CVHoDisTransitionData(Areas.CLOCK_A, 0x0C, 0, ERGroups.LEFT_A, 0x8F, 0x8F,
                                                    ent_names.ada_exit_cra, ent_names.crb_exit_adb,
                                                    AreaNames.CLOCK, TransitionNames.AD_CR, True),
    ent_names.cra_exit_swa:   CVHoDisTransitionData(Areas.CLOCK_A, 0x00, 0, ERGroups.LEFT_A, 0x67, 0x67,
                                                    ent_names.swa_exit_cra, ent_names.crb_exit_swb,
                                                    AreaNames.CLOCK, TransitionNames.SW_CR, True),
    ent_names.tfa_exit_cda:   CVHoDisTransitionData(Areas.TOP_A, 0x04, 2, ERGroups.RIGHT_MK_A, 0x67, 0x67,
                                                    ent_names.cda_exit_tfa, ent_names.tfb_exit_cdb,
                                                    AreaNames.TOP, TransitionNames.CD_TF, True),
    ent_names.tfa_exit_cya:   CVHoDisTransitionData(Areas.TOP_A, 0x08, 4, ERGroups.BOTTOM_A, 0xA3, 0x8F,
                                                    ent_names.cya_exit_tfa, ent_names.tfb_exit_cyb,
                                                    AreaNames.TOP, TransitionNames.CY_TF, False),
    ent_names.tfa_exit_mca:   CVHoDisTransitionData(Areas.TOP_A, 0x09, 0, ERGroups.LEFT_SKULL_A, 0x67, 0x67,
                                                    ent_names.mca_exit_tfa, ent_names.tfb_exit_mcb,
                                                    AreaNames.TOP, TransitionNames.MC_TF, True),
    # Castle B
    ent_names.etb_exit_sab:   CVHoDisTransitionData(Areas.ENTRANCE_B, 0x0C, 3, ERGroups.RIGHT_B, 0x67, 0x67,
                                                    ent_names.sab_exit_etb, ent_names.eta_exit_saa,
                                                    AreaNames.ENTRANCE, TransitionNames.ET_SA, True),
    ent_names.etb_exit_mcb:   CVHoDisTransitionData(Areas.ENTRANCE_B, 0x06, 3, ERGroups.RIGHT_B, 0x67, 0x67,
                                                    ent_names.mcb_exit_etb, ent_names.eta_exit_mca,
                                                    AreaNames.ENTRANCE, TransitionNames.ET_MC, True),
    ent_names.etb_exit_scb:   CVHoDisTransitionData(Areas.ENTRANCE_B, 0x0D, 4, ERGroups.BOTTOM_B, 0xA3, 0x8F,
                                                    ent_names.scb_exit_etb, ent_names.eta_exit_sca,
                                                    AreaNames.ENTRANCE, TransitionNames.ET_SC, False),
    ent_names.mcb_exit_etb:   CVHoDisTransitionData(Areas.MARBLE_B, 0x00, 0, ERGroups.LEFT_B, 0x67, 0x67,
                                                    ent_names.etb_exit_mcb, ent_names.mca_exit_eta,
                                                    AreaNames.MARBLE, TransitionNames.ET_MC, True),
    ent_names.mcb_exit_rib_l: CVHoDisTransitionData(Areas.MARBLE_B, 0x0E, 2, ERGroups.LEFT_B, 0x67, 0x67,
                                                    ent_names.rib_exit_mcb_l, ent_names.mca_exit_ria_l,
                                                    AreaNames.MARBLE, TransitionNames.MC_RI_L, False),
    ent_names.mcb_exit_rib_r: CVHoDisTransitionData(Areas.MARBLE_B, 0x0E, 1, ERGroups.RIGHT_B, 0x67, 0x67,
                                                    ent_names.rib_exit_mcb_r, ent_names.mca_exit_ria_r,
                                                    AreaNames.MARBLE, TransitionNames.MC_RI_R, False),
    ent_names.mcb_exit_wwb:   CVHoDisTransitionData(Areas.MARBLE_B, 0x0D, 1, ERGroups.RIGHT_B, 0x67, 0x67,
                                                    ent_names.wwb_exit_mcb, ent_names.mca_exit_wwa,
                                                    AreaNames.MARBLE, TransitionNames.MC_WW, True),
    ent_names.mcb_exit_tfb:   CVHoDisTransitionData(Areas.MARBLE_B, 0x0C, 1, ERGroups.RIGHT_SKULL_B, 0x67, 0x67,
                                                    ent_names.tfb_exit_mcb, ent_names.mca_exit_tfa,
                                                    AreaNames.MARBLE, TransitionNames.MC_TF, True),
    ent_names.rib_exit_mcb_l: CVHoDisTransitionData(Areas.MARBLE_B, 0x0F, 0, ERGroups.RIGHT_B, 0x67, 0x67,
                                                    ent_names.mcb_exit_rib_l, ent_names.ria_exit_mca_l,
                                                    AreaNames.ROOM, TransitionNames.MC_RI_L, False),
    ent_names.rib_exit_mcb_r: CVHoDisTransitionData(Areas.MARBLE_B, 0x10, 0, ERGroups.LEFT_B, 0x67, 0x67,
                                                    ent_names.mcb_exit_rib_r, ent_names.ria_exit_mca_r,
                                                    AreaNames.ROOM, TransitionNames.MC_RI_R, False),
    ent_names.wwb_exit_mcb:   CVHoDisTransitionData(Areas.SHRINE_B, 0x02, 0, ERGroups.LEFT_B, 0x67, 0x67,
                                                    ent_names.mcb_exit_wwb, ent_names.wwa_exit_mca,
                                                    AreaNames.WAILING, TransitionNames.MC_WW, True),
    ent_names.wwb_exit_cyb:   CVHoDisTransitionData(Areas.SHRINE_B, 0x08, 1, ERGroups.RIGHT_SKULL_B, 0x67, 0x67,
                                                    ent_names.cyb_exit_wwb, ent_names.wwa_exit_cya,
                                                    AreaNames.WAILING, TransitionNames.WW_CY, True),
    ent_names.wwb_exit_sab:   CVHoDisTransitionData(Areas.SHRINE_B, 0x09, 1, ERGroups.RIGHT_B, 0x67, 0x67,
                                                    ent_names.sab_exit_wwb, ent_names.wwa_exit_saa,
                                                    AreaNames.WAILING, TransitionNames.WW_SA, False),
    ent_names.sab_exit_wwb:   CVHoDisTransitionData(Areas.SHRINE_B, 0x0A, 1, ERGroups.LEFT_B, 0x67, 0x67,
                                                    ent_names.wwb_exit_sab, ent_names.saa_exit_wwa,
                                                    AreaNames.SHRINE, TransitionNames.WW_SA, False),
    ent_names.sab_exit_etb:   CVHoDisTransitionData(Areas.SHRINE_B, 0x0F, 0, ERGroups.LEFT_B, 0x67, 0x67,
                                                    ent_names.etb_exit_sab, ent_names.saa_exit_eta,
                                                    AreaNames.SHRINE, TransitionNames.ET_SA, True),
    ent_names.cyb_exit_scb:   CVHoDisTransitionData(Areas.TREASURY_B, 0x0F, 0, ERGroups.LEFT_B, 0x67, 0x67,
                                                    ent_names.scb_exit_cyb, ent_names.cya_exit_sca,
                                                    AreaNames.TREASURY, TransitionNames.CY_SC, True),
    ent_names.cyb_exit_lcb:   CVHoDisTransitionData(Areas.TREASURY_B, 0x0E, 0, ERGroups.RIGHT_B, 0x67, 0x67,
                                                    ent_names.lcb_exit_cyb, ent_names.cya_exit_lca,
                                                    AreaNames.TREASURY, TransitionNames.CY_LC, True),
    ent_names.cyb_exit_wwb:   CVHoDisTransitionData(Areas.TREASURY_B, 0x15, 0, ERGroups.LEFT_SKULL_B, 0x67, 0x67,
                                                    ent_names.wwb_exit_cyb, ent_names.cya_exit_wwa,
                                                    AreaNames.TREASURY, TransitionNames.WW_CY, True),
    ent_names.cyb_exit_tfb:   CVHoDisTransitionData(Areas.TREASURY_B, 0x15, 1, ERGroups.TOP_B, 0x9F, 0x1F,
                                                    ent_names.tfb_exit_cyb, ent_names.cya_exit_tfa,
                                                    AreaNames.TREASURY, TransitionNames.CY_TF, False),
    ent_names.scb_exit_cyb:   CVHoDisTransitionData(Areas.SKELETON_B, 0x00, 1, ERGroups.RIGHT_B, 0x67, 0x67,
                                                    ent_names.cyb_exit_scb, ent_names.sca_exit_cya,
                                                    AreaNames.SKELETON, TransitionNames.CY_SC, True),
    ent_names.scb_exit_etb:   CVHoDisTransitionData(Areas.SKELETON_B, 0x0D, 0, ERGroups.TOP_B, 0x9F, 0x1F,
                                                    ent_names.etb_exit_scb, ent_names.sca_exit_eta,
                                                    AreaNames.SKELETON, TransitionNames.ET_SC, False),
    ent_names.lcb_exit_cyb:   CVHoDisTransitionData(Areas.LUMINOUS_B, 0x00, 1, ERGroups.LEFT_B, 0x67, 0x67,
                                                    ent_names.cyb_exit_lcb, ent_names.lca_exit_cya,
                                                    AreaNames.LUMINOUS, TransitionNames.CY_LC, True),
    ent_names.lcb_exit_adb:   CVHoDisTransitionData(Areas.LUMINOUS_B, 0x04, 1, ERGroups.RIGHT_B, 0x67, 0x67,
                                                    ent_names.adb_exit_lcb, ent_names.lca_exit_ada,
                                                    AreaNames.LUMINOUS, TransitionNames.LC_AD, True),
    ent_names.swb_exit_cdb:   CVHoDisTransitionData(Areas.CHAPEL_B, 0x06, 0, ERGroups.LEFT_B, 0x7F, 0x7F,
                                                    ent_names.cdb_exit_swb, ent_names.swa_exit_cda,
                                                    AreaNames.WALKWAY, TransitionNames.SW_CD, False),
    ent_names.swb_exit_crb:   CVHoDisTransitionData(Areas.CHAPEL_B, 0x0E, 1, ERGroups.RIGHT_B, 0x67, 0x67,
                                                    ent_names.crb_exit_swb, ent_names.swa_exit_cra,
                                                    AreaNames.WALKWAY, TransitionNames.SW_CR, True),
    ent_names.swb_exit_adb:   CVHoDisTransitionData(Areas.CHAPEL_B, 0x12, 0, ERGroups.LEFT_B, 0x67, 0x67,
                                                    ent_names.adb_exit_swb, ent_names.swa_exit_ada,
                                                    AreaNames.WALKWAY, TransitionNames.SW_AD, True),
    ent_names.cdb_exit_swb:   CVHoDisTransitionData(Areas.CHAPEL_B, 0x05, 1, ERGroups.RIGHT_B, 0x7F, 0x7F,
                                                    ent_names.swb_exit_cdb, ent_names.cda_exit_swa,
                                                    AreaNames.CHAPEL, TransitionNames.SW_CD, False),
    ent_names.cdb_exit_tfb:   CVHoDisTransitionData(Areas.CHAPEL_B, 0x00, 0, ERGroups.LEFT_MK_B, 0x67, 0x67,
                                                    ent_names.tfb_exit_cdb, ent_names.cda_exit_tfa,
                                                    AreaNames.CHAPEL, TransitionNames.CD_TF, True),
    ent_names.adb_exit_swb:   CVHoDisTransitionData(Areas.AQUEDUCT_B, 0x06, 1, ERGroups.RIGHT_B, 0x67, 0x67,
                                                    ent_names.swb_exit_adb, ent_names.ada_exit_swa,
                                                    AreaNames.AQUEDUCT, TransitionNames.SW_AD, True),
    ent_names.adb_exit_lcb:   CVHoDisTransitionData(Areas.AQUEDUCT_B, 0x00, 0, ERGroups.LEFT_B, 0x67, 0x67,
                                                    ent_names.lcb_exit_adb, ent_names.ada_exit_lca,
                                                    AreaNames.AQUEDUCT, TransitionNames.LC_AD, True),
    ent_names.adb_exit_crb:   CVHoDisTransitionData(Areas.AQUEDUCT_B, 0x0A, 1, ERGroups.RIGHT_B, 0x8F, 0x8F,
                                                    ent_names.crb_exit_adb, ent_names.ada_exit_cra,
                                                    AreaNames.AQUEDUCT, TransitionNames.AD_CR, True),
    ent_names.crb_exit_adb:   CVHoDisTransitionData(Areas.CLOCK_B, 0x0C, 0, ERGroups.LEFT_B, 0x8F, 0x8F,
                                                    ent_names.adb_exit_crb, ent_names.cra_exit_ada,
                                                    AreaNames.CLOCK, TransitionNames.AD_CR, True),
    ent_names.crb_exit_swb:   CVHoDisTransitionData(Areas.CLOCK_B, 0x00, 0, ERGroups.LEFT_B, 0x67, 0x67,
                                                    ent_names.swb_exit_crb, ent_names.cra_exit_swa,
                                                    AreaNames.CLOCK, TransitionNames.SW_CR, True),
    ent_names.tfb_exit_cdb:   CVHoDisTransitionData(Areas.TOP_B, 0x04, 2, ERGroups.RIGHT_MK_B, 0x67, 0x67,
                                                    ent_names.cdb_exit_tfb, ent_names.tfa_exit_cda,
                                                    AreaNames.TOP, TransitionNames.CD_TF, True),
    ent_names.tfb_exit_cyb:   CVHoDisTransitionData(Areas.TOP_B, 0x08, 4, ERGroups.BOTTOM_B, 0xA3, 0x8F,
                                                    ent_names.cyb_exit_tfb, ent_names.tfa_exit_cya,
                                                    AreaNames.TOP, TransitionNames.CY_TF, False),
    ent_names.tfb_exit_mcb:   CVHoDisTransitionData(Areas.TOP_B, 0x09, 0, ERGroups.LEFT_SKULL_B, 0x67, 0x67,
                                                    ent_names.mcb_exit_tfb, ent_names.tfa_exit_mca,
                                                    AreaNames.TOP, TransitionNames.MC_TF, True),
}
