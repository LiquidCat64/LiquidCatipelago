...
LEFT_GROUPS = [ERGroups.LEFT_A, ERGroups.LEFT_B]
RIGHT_GROUPS = [ERGroups.RIGHT_A, ERGroups.RIGHT_B]
...
class CVHoDisTransitionData(NamedTuple):
    ...
    castle_direction: int # Number in the ERGroups enum for which side of the screen the destination's room transition
                          # is on as well as what castle the destination belongs to.
...
SHUFFLEABLE_TRANSITIONS: dict[str, CVHoDisTransitionData] = {
    ...
    ent_names.mca_exit_tfa:   CVHoDisTransitionData(0x49B2AC, 0x849B2B8, 0x0210, 0x0000, ERGroups.RIGHT_A, 0x67, 0x67),
    ...
    ent_names.wwa_exit_cya:   CVHoDisTransitionData(0x49D37C, 0x849D388, 0x0110, 0x0000, ERGroups.RIGHT_A, 0x67, 0x67),
    ...
    ent_names.cya_exit_wwa:   CVHoDisTransitionData(0x4AD458, 0x84AD47C, 0x0000, 0x0000, ERGroups.LEFT_A, 0x67, 0x67),
    ...
    ent_names.cda_exit_tfa:   CVHoDisTransitionData(0x4A7248, 0x84A7260, 0x0000, 0x0130, ERGroups.LEFT_A, 0x67, 0x67),
    ...
    ent_names.tfa_exit_cda:   CVHoDisTransitionData(0x49F280, 0x849F28C, 0x0110, 0x0130, ERGroups.RIGHT_A, 0x67, 0x67),
    ent_names.tfa_exit_cya:   CVHoDisTransitionData(0x49F4F8, 0x849F504, 0x0000, 0x0560, ERGroups.BOTTOM_A, 0xA3, 0x8F),
    ent_names.tfa_exit_mca:   CVHoDisTransitionData(0x49F570, 0x849F588, 0x0000, 0x0130, ERGroups.LEFT_A, 0x67, 0x67),
    # Castle B
    ...
    ent_names.mcb_exit_tfb:   CVHoDisTransitionData(0x49C518, 0x849C524, 0x0210, 0x0000, ERGroups.RIGHT_B, 0x67, 0x67),
    ...
    ent_names.wwb_exit_cyb:   CVHoDisTransitionData(0x49E400, 0x849E40C, 0x0110, 0x0000, ERGroups.RIGHT_B, 0x67, 0x67),
    ...
    ent_names.cyb_exit_wwb:   CVHoDisTransitionData(0x4AED20, 0x84AED44, 0x0000, 0x0000, ERGroups.LEFT_B, 0x67, 0x67),
    ...
    ent_names.cdb_exit_tfb:   CVHoDisTransitionData(0x4A84A0, 0x84A84B8, 0x0000, 0x0130, ERGroups.LEFT_B, 0x67, 0x67),
    ...
    ent_names.tfb_exit_cdb:   CVHoDisTransitionData(0x49FF90, 0x849FF9C, 0x0110, 0x0130, ERGroups.RIGHT_B, 0x67, 0x67),
    ent_names.tfb_exit_cyb:   CVHoDisTransitionData(0x4A020C, 0x84A0218, 0x0000, 0x0560, ERGroups.BOTTOM_B, 0xA3, 0x8F),
    ent_names.tfb_exit_mcb:   CVHoDisTransitionData(0x4A0284, 0x84A029C, 0x0000, 0x0130, ERGroups.LEFT_B, 0x67, 0x67)
}
...
def link_room_transitions(transition_pairings: list[tuple]) -> dict[int, bytes]:
    ...
    for pair in transition_pairings:
        ...
        # shift by 0.
        if SHUFFLEABLE_TRANSITIONS[pair[0]].castle_direction in VERTICAL_GROUPS and \
             SHUFFLEABLE_TRANSITIONS[pair[1]].castle_direction in VERTICAL_GROUPS:
        ...
        if SHUFFLEABLE_TRANSITIONS[pair[0]].castle_direction in VERTICAL_GROUPS and pair[1] in VERTICAL_SHAFT_EXITS:
        ...
        elif SHUFFLEABLE_TRANSITIONS[pair[0]].castle_direction in VERTICAL_GROUPS and \
                SHUFFLEABLE_TRANSITIONS[pair[1]].castle_direction in LEFT_GROUPS:
        ...
        # If the entrance is a vertical transition and the exit is on the right, set 0x58 as the player X offset.
                ...
                SHUFFLEABLE_TRANSITIONS[pair[1]].castle_direction in RIGHT_GROUPS:
        ...
        elif SHUFFLEABLE_TRANSITIONS[pair[0]].castle_direction in RIGHT_GROUPS and \
                SHUFFLEABLE_TRANSITIONS[pair[1]].castle_direction in TOP_GROUPS:
        ...
        elif SHUFFLEABLE_TRANSITIONS[pair[0]].castle_direction in LEFT_GROUPS and \
                SHUFFLEABLE_TRANSITIONS[pair[1]].castle_direction in TOP_GROUPS:
        ...
        # If the entrance is on the right and the exit is on the bottom, set 0x4F as the player X offset.
                ...
                SHUFFLEABLE_TRANSITIONS[pair[1]].castle_direction in BOTTOM_GROUPS:
