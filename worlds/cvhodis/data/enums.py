...
class EventFlags(IntEnum):
    ...
    PRESSED_LUMINOUS_B_CRATE_BUTTON = 0x21
    RODE_LUMINOUS_B_ELEVATOR = 0x22
    BROKE_LUMINOUS_A_WARP_ROOM_CRUSHING_STONE_WALL = 0x23
    HAMMERED_BRONZE_GUARDER = 0x24
    LOWERED_CLOCK_B_CRANKSHAFT = 0x25
    FIRST_MERCHANT_VISIT = 0x26
    BROKE_WALKWAY_B_PRE_SHADOW_CRUSHING_STONE_WALL = 0x27
    UNLOCKED_MK_BRACELET_DOORS = 0x28
    BROKE_TOP_A_STAIRS_CRUSHING_STONE_WALL = 0x29
    UNLOCKED_TREASURY_LOWER_LURE_DOOR = 0x2A
    UNLOCKED_MARBLE_TOP_SKULL_DOORS = 0x2B
    UNLOCKED_WAILING_TREASURY_SKULL_DOORS = 0x2C
    UNLOCKED_TREASURY_UPPER_LURE_DOOR = 0x2D
    BROKE_ENTRANCE_A_SUB_SHAFT_UPPER_CRUSHING_STONE_WALL = 0x2E
    BROKE_ENTRANCE_A_SUB_SHAFT_LOWER_CRUSHING_STONE_WALL = 0x2F
    BROKE_ENTRANCE_B_SUB_SHAFT_UPPER_CRUSHING_STONE_WALL = 0x30
    BROKE_ENTRANCE_B_SUB_SHAFT_LOWER_CRUSHING_STONE_WALL = 0x31
    BROKE_ENTRANCE_RAMP_STATUE = 0x32
    BROKE_SKELETON_B_LOWER_CRUSHING_STONE_WALL = 0x33
    BROKE_SKELETON_B_CROCOMIRE_LOGS = 0x34
    BROKE_AQUEDUCT_LOWER_CRUSHING_STONE_WALL = 0x35
    ROLLED_SKELETON_B_GIANT_SKULL = 0x36
    BROKE_SKELETON_B_ROCK_LOGS = 0x37
    CUTSCENE_EVIL_MAXIMS_INTRODUCTION = 0x38
    SAW_ENTRANCE_DRAWBRIDGE_RAISE = 0x39
    CUTSCENE_CASTLE_ARRIVAL = 0x3A
    CUTSCENE_MAXIM_FEELS_DAZED = 0x3B
    CUTSCENE_MAXIMS_CONFESSION = 0x3C
    CUTSCENE_DEATHS_CASTLES_EXPLANATION = 0x3D
    CUTSCENE_EVIL_MAXIM_SUMMONS_SHADOW = 0x3E
    CUTSCENE_MAXIM_GIVES_BRACELET = 0x3F
    CUTSCENE_DEATH_KIDNAPS_LYDIE = 0x40
    CUTSCENE_DEATH_PRE_FIGHT = 0x41
    CUTSCENE_CENTER_A_MAXIM_PRE_FIGHT = 0x42
    CUTSCENE_DEATHS_INTRODUCTION = 0x43
    CUTSCENE_CENTER_B_MAXIM_PRE_FIGHT = 0x44
    CUTSCENE_MEDIUM_ENDING_MAXIMS_DEATH = 0x45
    CUTSCENE_WORST_ENDING_MAXIMS_DEATH = 0x46
    DEFEATED_MAXIM_WITH_BRACELETS = 0x48
    CUTSCENE_ENDING_OUTSIDE = 0x4A
    UNLOCKED_ENTRANCE_LURE_DOOR = 0x4B
    FIRST_FURNITURE_ROOM_VISIT = 0x4C
    FIRST_CASTLE_CHANGE = 0x4D
    BROKE_TOP_A_ATTIC_CRUSH_BOOTS_CEILING = 0x4E
    BROKE_TOP_B_ATTIC_CRUSH_BOOTS_CEILING = 0x4F
    BROKE_TOP_A_STAIRS_CRUSH_BOOTS_CEILING = 0x50
    BROKE_TOP_B_STAIRS_CRUSH_BOOTS_CEILING = 0x51
    BROKE_ENTRANCE_B_GATEHOUSE_CRUSH_BOOTS_CEILING = 0x52
    OPENED_CENTER_A_FLOOR_GATE = 0x53
    OPENED_CENTER_B_FLOOR_GATE = 0x54
    DESTROYED_GATE_GUARDER_BOULDER = 0x55
    DESTROYED_GUARDIAN_ARMOR = 0x56
    FIRST_CASTLE_CHANGE_AFTER_DEATH_EXPLANATION = 0x57
    DEFEATED_MAXIM = 0x58
    DEFEATED_DRACULA_WRAITH_1 = 0x59
    BROKE_ENTRANCE_A_GATEHOUSE_CRUSH_BOOTS_CEILING = 0x5A
    DEFEATED_MARBLE_A_VICTORY_ARMOR = 0x64
    DEFEATED_SHRINE_A_VICTORY_ARMOR = 0x66
