...
portal_death_room_checker = [
    ...
    0x00, 0x00,
    0x02, 0x21,  # mov  r1, 0x02
    0x09, 0x06,  # lsl  r1, r1, 0x18
    0x70, 0x31,  # add  r1, 0x70
    0x09, 0x88,  # ldrh r1, [r1]
    0x0C, 0x22,  # mov  r2, 0x0C
    0x12, 0x02,  # lsl  r2, r2, 0x08
    0x70, 0x32,  # add  r2, 0x70
    0x91, 0x42,  # cmp  r1, r2
    0x01, 0xD0,  # beq  [forward 0x02]
    # If they aren't, jump to the "close gates" part of the code.
    0x03, 0x49,  # ldr  r1, 0x801BB18
    0x8F, 0x46,  # mov  r15, r1
    # If they are, jump to the "open gates" part of the code.
    0x80, 0x03,  # lsl  r0, r0, 0x0E
    0x60, 0x61,  # str  r0, [r4, 0x14]
    0x1E, 0x20,  # mov  r0, 0x1E
    0xA0, 0x72,  # strb r0, [r4, 0x0A]
    0x01, 0x49,  # ldr  r1, 0x801BB44
    0x8F, 0x46,  # mov  r15, r1
    # LDR number pool
    0x18, 0xBB, 0x01, 0x08,
    0x44, 0xBB, 0x01, 0x08
...
post_intro_autosave = [
    ...
    0x01, 0x23,  # mov  r3, 0x01
    0x1A, 0x43,  # orr  r2, r3
    0x4A, 0x75,  # strb r2, [r1, 0x15]
    # Run the "update file metadata" function.
    0x02, 0x20,  # mov  r0, 0x02
    0x00, 0x06,  # lsl  r0, r0, 0x18
    0x48, 0x30,  # add  r0, 0x48
    0x11, 0x4A,  # ldr  r2, 0x800BA0C
    0x7B, 0x46,  # mov  r3, r15
    0x05, 0x33,  # add  r3, 0x05
    0x9E, 0x46,  # mov  r14, r3
    0x97, 0x46,  # mov  r15, r2
    ...
    0x04, 0x30,  # add  r0, 0x04
    0x00, 0x02,  # lsl  r0, r0, 0x08
    0xC0, 0x78,  # ldrb r0, [r0, 0x03]
    0x0A, 0x4A,  # ldr  r2, 0x800BA54
    0x7B, 0x46,  # mov  r3, r15
    0x05, 0x33,  # add  r3, 0x05
    0x9E, 0x46,  # mov  r14, r3
    0x97, 0x46,  # mov  r15, r2
    ...
    0x02, 0x20,  # mov  r0, 0x02
    0x00, 0x02,  # lsl  r0, r0, 0x08
    0x46, 0x30,  # add  r0, 0x46
    0x07, 0x4A,  # ldr  r2, 0x8008330
    0x7B, 0x46,  # mov  r3, r15
    0x05, 0x33,  # add  r3, 0x05
    0x9E, 0x46,  # mov  r14, r3
    0x97, 0x46,  # mov  r15, r2
    ...
    0x04, 0xBC,  # pop  r2
    0x61, 0x32,  # add  r2, 0x61
    0x10, 0x78,  # ldrb r0, [r2]
    0x08, 0x21,  # mov  r1, 0x08
    0x08, 0x43,  # orr  r0, r1
    0x00, 0x4B,  # ldr  r3, 0x8095554
    0x9F, 0x46,  # mov  r15, r3
    # LDR number pool
    0x54, 0x55, 0x09, 0x08,
    0x54, 0xBA, 0x00, 0x08,
