...
ALL_CVHODIS_REGIONS: dict[str, RegionInfo] = {
    ...
    "Walkway A Clock Exit Room": {"entrances": {"Clock A Pendulum Area": "Walkway A Right Door",
    ...
    "Clock A Main": {"locations": [loc_names.cra1,
                     ...
                     "entrances": {"Clock A Pendulum Area": "Clock A Down from Main",
                                   ...
                                   "Clock B Main": "Clock A Warp Gate"}},
    ...
    "Top A Throne Room": {"locations": [loc_names.tfa15,
                          ...
                          "entrances": {"Top B Throne Room": "Top A Warp Gate",
                                        ...
                                        "Top A Middle": "Top A Throne Button Press"}},
    ...
    "Entrance B Main": {"locations": [loc_names.etb0,
                                      ...
                                      loc_names.etb9,
                                      loc_names.etb13a],
                        "entrances": {"Shrine B Main": "Entrance B Middle Door",
    ...
    "Entrance B Sub Shaft": {"locations": [loc_names.etb13b,
                                           loc_names.etb13c],
    ...
    "Walkway B Clock Exit Room": {"entrances": {"Clock B Pendulum Area": "Walkway B Right Door",
    ...
    "Clock B Main": {"locations": [loc_names.crb1,
                     ...
                     "entrances": {"Clock B Pendulum Area": "Clock B Down from Main",
                                   ...
                                   "Clock A Main": "Clock B Warp Gate"}},
