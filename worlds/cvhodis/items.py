...
USE_ITEMS: dict[str, CVHoDisItemData] = {
    ...
    item_names.use_hint_1:    CVHoDisItemData(0x10),
    item_names.use_hint_2:    CVHoDisItemData(0x11),
    item_names.use_hint_3:    CVHoDisItemData(0x12),
    item_names.use_hint_4:    CVHoDisItemData(0x13),
    item_names.use_hint_5:    CVHoDisItemData(0x14),
    item_names.use_hint_6:    CVHoDisItemData(0x15),
