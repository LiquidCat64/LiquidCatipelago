...
- A Castlevania: Harmony of Dissonance ROM of the US version specifically. The Archipelago community cannot provide this.
The Castlevania Advance Collection ROM can be used, but it has no audio.
...
1. Create your settings file (YAML). You can make one on the [Castlevania: Harmony of Dissonance options page](../../../games/Castlevania%20-%20Harmony%20of%20Dissonance/player-options).
...
1. Castlevania: Harmony of Dissonance uses Archipelago's BizHawk Client. If the client isn't still open from when you patched your game,
...
Client window should indicate that it connected and recognized Castlevania: Harmony of Dissonance.
