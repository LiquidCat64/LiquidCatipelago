...
stage_info = {
    ...
    "The Outer Wall": {
        "start region": rname.tow_start, "start map id": 0x2A, "start spawn id": 0x00,
        "mid region": rname.tow_mid, "mid map id": 0x2A, "mid spawn id": 0x0C,
        "end region": rname.tow_end, "end map id": 0x2A, "end spawn id": 0x0B,
        "endzone map offset": 0x109B67, "endzone spawn offset": 0x109B69, "character": "Cornell",
        "save number offsets": [0x104A35, 0x104A3D],
        "regions": [rname.tow_start,
                    rname.tow_mid,
                    rname.tow_end]
    },

    "Art Tower": {
        "start region": rname.at_start, "start map id": 0x25, "start spawn id": 0x00,
        "startzone map offset": 0x818DF2, "startzone spawn offset": 0x818DF3,
        "mid region": rname.at_end, "mid map id": 0x26, "mid spawn id": 0x02,
        "end region": rname.at_end, "end map id": 0x26, "end spawn id": 0x01,
        "endzone map offset": 0x109B67, "endzone spawn offset": 0x109B69, "character": "Cornell",
        "save number offsets": [0x104A35, 0x104A3D],
        "regions": [rname.at_start,
                    rname.at_middle,
                    rname.at_end]
    },
    ...
    "Clock Tower": {
        ...
        "mid region": rname.ct_abyss_near, "mid map id": 0x28, "mid spawn id": 0x02,
        "end region": rname.ct_face, "end map id": 0x29, "end spawn id": 0x03,
...
def verify_character_stage(world: "CVLoDWorld", stage: str) -> bool:
...
def get_normal_stage_exits(world: "CVLoDWorld") -> Dict[str, dict]:
