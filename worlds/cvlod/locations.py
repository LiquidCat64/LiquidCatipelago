...
CVLOD_LOCATIONS_INFO = {
    ...
    # Art Tower
    loc_names.atm_ww:            CVLoDLocationData(0x22A, Scenes.ART_TOWER_MUSEUM, item_names.gold_300, actor=("room 2", 6)),
    loc_names.atm_nw_ped:        CVLoDLocationData(0x236, Scenes.ART_TOWER_MUSEUM, item_names.sub_holy, actor=("room 4", 6)),
    loc_names.atm_nw_corner:     CVLoDLocationData(0x22B, Scenes.ART_TOWER_MUSEUM, item_names.use_card_m, actor=("room 4", 5)),
    loc_names.atm_sw_alcove_1:   CVLoDLocationData(0x22C, Scenes.ART_TOWER_MUSEUM, item_names.jewel_rl, actor=("room 0", 18)),
    loc_names.atm_sw_alcove_2:   CVLoDLocationData(0x22D, Scenes.ART_TOWER_MUSEUM, item_names.jewel_rs, actor=("room 0", 20)),
    loc_names.atm_sw_alcove_4:   CVLoDLocationData(0x22E, Scenes.ART_TOWER_MUSEUM, item_names.gold_100, actor=("room 0", 22)),
    loc_names.atm_sw_alcove_6:   CVLoDLocationData(0x22F, Scenes.ART_TOWER_MUSEUM, item_names.sub_holy, actor=("room 0", 23)),
    loc_names.atm_sw_key_ped:    CVLoDLocationData(0x286, Scenes.ART_TOWER_MUSEUM, item_names.quest_key_art_1, actor=("room 8", 3)),
    loc_names.atm_sw_key_corner: CVLoDLocationData(0x230, Scenes.ART_TOWER_MUSEUM, item_names.use_purifying, actor=("room 8", 4)),
    loc_names.atm_se:            CVLoDLocationData(0x231, Scenes.ART_TOWER_MUSEUM, item_names.powerup, actor=("room 1", 6)),
    loc_names.atm_ne_ped:        CVLoDLocationData(0x237, Scenes.ART_TOWER_MUSEUM, item_names.gold_500, actor=("room 3", 5)),
    loc_names.atm_ne_near:       CVLoDLocationData(0x232, Scenes.ART_TOWER_MUSEUM, item_names.use_card_s, actor=("room 3", 4)),
    loc_names.atm_ee_plat_1:     CVLoDLocationData(0x233, Scenes.ART_TOWER_MUSEUM, item_names.jewel_rs, actor=("room 9", 26)),
    loc_names.atm_ee_plat_2:     CVLoDLocationData(0x234, Scenes.ART_TOWER_MUSEUM, item_names.jewel_rl, actor=("room 9", 27)),
    loc_names.atm_ee_key_ped:    CVLoDLocationData(0x287, Scenes.ART_TOWER_MUSEUM, item_names.quest_key_art_2, actor=("room 7", 4)),
    loc_names.atm_ee_key_corner: CVLoDLocationData(0x235, Scenes.ART_TOWER_MUSEUM, item_names.use_card_m, actor=("room 7", 5)),
    loc_names.atc_sw_statue_l:   CVLoDLocationData(0x23D, Scenes.ART_TOWER_CONSERVATORY, item_names.use_purifying, actor=("proxy", 43)),
    loc_names.atc_sw_statue_r:   CVLoDLocationData(0x23C, Scenes.ART_TOWER_CONSERVATORY, item_names.jewel_rl, actor=("proxy", 41)),
    loc_names.atc_ne_statue_l:   CVLoDLocationData(0x23E, Scenes.ART_TOWER_CONSERVATORY, item_names.jewel_rs, actor=("proxy", 45)),
    loc_names.atc_ne_statue_r:   CVLoDLocationData(0x23F, Scenes.ART_TOWER_CONSERVATORY, item_names.jewel_rs, actor=("proxy", 47)),
    loc_names.atc_organ:         CVLoDLocationData(0x23B, Scenes.ART_TOWER_CONSERVATORY, item_names.use_ampoule, actor=("proxy", 40)),
    loc_names.atc_pillar_l:      CVLoDLocationData(0x23A, Scenes.ART_TOWER_CONSERVATORY, item_names.use_chicken, actor=("proxy", 39)),
    loc_names.atc_pillar_r:      CVLoDLocationData(0x239, Scenes.ART_TOWER_CONSERVATORY, item_names.sub_cross, actor=("proxy", 36)),
    loc_names.atc_doorway_l:     CVLoDLocationData(0x2AF, Scenes.ART_TOWER_CONSERVATORY, item_names.gold_500, actor=("proxy", 55)),
    loc_names.atc_doorway_m:     CVLoDLocationData(0x2AE, Scenes.ART_TOWER_CONSERVATORY, item_names.use_beef, actor=("proxy", 54)),
    loc_names.atc_doorway_r:     CVLoDLocationData(0x2B0, Scenes.ART_TOWER_CONSERVATORY, item_names.gold_500, actor=("proxy", 56)),
    loc_names.atc_balcony_save:  CVLoDLocationData(0x240, Scenes.ART_TOWER_CONSERVATORY, item_names.sub_cross, actor=("proxy", 48)),
    loc_names.atc_bp_f:          CVLoDLocationData(0x241, Scenes.ART_TOWER_CONSERVATORY, item_names.use_purifying, actor=("proxy", 50)),
    loc_names.atc_bp_r:          CVLoDLocationData(0x242, Scenes.ART_TOWER_CONSERVATORY, item_names.gold_300, actor=("proxy", 52)),

    # Tower of Ruins
    loc_names.torm_trap_side:   CVLoDLocationData(0x20D, Scenes.RUINS_DOOR_MAZE, item_names.sub_holy, actor=("room 24", 9)),
    loc_names.torm_trap_corner: CVLoDLocationData(0x20E, Scenes.RUINS_DOOR_MAZE, item_names.jewel_rl, actor=("room 24", 11)),
    loc_names.torm_b6:          CVLoDLocationData(0x201, Scenes.RUINS_DOOR_MAZE, item_names.gold_300, actor=("room 10", 17)),
    loc_names.torm_b4_corner:   CVLoDLocationData(0x206, Scenes.RUINS_DOOR_MAZE, item_names.jewel_rl, actor=("room 7", 14)),
    loc_names.torm_b4_statue:   CVLoDLocationData(0x200, Scenes.RUINS_DOOR_MAZE, item_names.use_chicken, actor=("room 7", 13)),
    loc_names.torm_a3:          CVLoDLocationData(0x205, Scenes.RUINS_DOOR_MAZE, item_names.powerup, actor=("room 3", 11)),
    loc_names.torm_b2:          CVLoDLocationData(0x208, Scenes.RUINS_DOOR_MAZE, item_names.sub_holy, actor=("room 12", 7)),
    loc_names.torm_a1:          CVLoDLocationData(0x207, Scenes.RUINS_DOOR_MAZE, item_names.gold_300, actor=("room 11", 10)),
    loc_names.torm_d4:          CVLoDLocationData(0x203, Scenes.RUINS_DOOR_MAZE, item_names.powerup, actor=("room 1", 9)),
    loc_names.torm_g4:          CVLoDLocationData(0x20B, Scenes.RUINS_DOOR_MAZE, item_names.use_purifying, actor=("room 14", 17)),
    loc_names.torm_g3_l:        CVLoDLocationData(0x209, Scenes.RUINS_DOOR_MAZE, item_names.sub_holy, actor=("room 13", 13)),
    loc_names.torm_g3_r:        CVLoDLocationData(0x20A, Scenes.RUINS_DOOR_MAZE, item_names.sub_cross, actor=("room 13", 15)),
    loc_names.torm_g3_s:        CVLoDLocationData(0x202, Scenes.RUINS_DOOR_MAZE, item_names.gold_300, actor=("room 13", 11)),
    loc_names.torm_lookback_l:  CVLoDLocationData(0x211, Scenes.RUINS_DOOR_MAZE, item_names.jewel_rs, actor=("room 18", 9)),
    loc_names.torm_lookback_r:  CVLoDLocationData(0x210, Scenes.RUINS_DOOR_MAZE, item_names.jewel_rs, actor=("room 18", 7)),
    loc_names.torm_lookback_u:  CVLoDLocationData(0x20C, Scenes.RUINS_DOOR_MAZE, item_names.use_chicken, actor=("room 18", 10)),
    loc_names.torc_lfloor_f:    CVLoDLocationData(0x215, Scenes.RUINS_DARK_CHAMBERS, item_names.jewel_rl, actor=("room 0", 114)),
    loc_names.torc_lfloor_r:    CVLoDLocationData(0x216, Scenes.RUINS_DARK_CHAMBERS, item_names.jewel_rs, actor=("room 0", 115)),
    loc_names.torc_walkway_l:   CVLoDLocationData(0x21C, Scenes.RUINS_DARK_CHAMBERS, item_names.jewel_rs, actor=("room 0", 123)),
    loc_names.torc_ufloor_rl:   CVLoDLocationData(0x21B, Scenes.RUINS_DARK_CHAMBERS, item_names.jewel_rs, actor=("room 0", 121)),
    loc_names.torc_ufloor_m:    CVLoDLocationData(0x219, Scenes.RUINS_DARK_CHAMBERS, item_names.powerup, actor=("room 0", 116)),
    loc_names.torc_ufloor_fr:   CVLoDLocationData(0x21A, Scenes.RUINS_DARK_CHAMBERS, item_names.sub_holy, actor=("room 0", 118)),
    loc_names.torc_meat_l:      CVLoDLocationData(0x2AC, Scenes.RUINS_DARK_CHAMBERS, item_names.use_beef, actor=("room 0", 112)),
    loc_names.torc_meat_r:      CVLoDLocationData(0x2AD, Scenes.RUINS_DARK_CHAMBERS, item_names.powerup, actor=("room 0", 113)),
    loc_names.torc_walkway_u:   CVLoDLocationData(0x21D, Scenes.RUINS_DARK_CHAMBERS, item_names.gold_300, actor=("room 0", 125)),
    loc_names.torc_aries:       CVLoDLocationData(0x21E, Scenes.RUINS_DARK_CHAMBERS, item_names.jewel_rs, actor=("room 1", 45)),
    loc_names.torc_taurus:      CVLoDLocationData(0x21F, Scenes.RUINS_DARK_CHAMBERS, item_names.gold_100, actor=("room 1", 47)),
    loc_names.torc_leo:         CVLoDLocationData(0x220, Scenes.RUINS_DARK_CHAMBERS, item_names.use_purifying, actor=("room 1", 48)),
    loc_names.torc_sagittarius: CVLoDLocationData(0x221, Scenes.RUINS_DARK_CHAMBERS, item_names.sub_cross, actor=("room 1", 49)),
    loc_names.torc_across_exit: CVLoDLocationData(0x223, Scenes.RUINS_DARK_CHAMBERS, item_names.use_card_m, actor=("room 1", 51)),
    loc_names.torc_near_exit:   CVLoDLocationData(0x222, Scenes.RUINS_DARK_CHAMBERS, item_names.use_card_s, actor=("room 1", 50)),

    # Castle Center
    loc_names.ccb_skel_hallway_ent:          CVLoDLocationData(0xF5, Scenes.CASTLE_CENTER_BASEMENT, item_names.jewel_rs, actor=("room 1", 51)),
    loc_names.ccb_skel_hallway_jun:          CVLoDLocationData(0xF8, Scenes.CASTLE_CENTER_BASEMENT, item_names.powerup, actor=("room 1", 44)),
    loc_names.ccb_skel_hallway_tc:           CVLoDLocationData(0xF6, Scenes.CASTLE_CENTER_BASEMENT, item_names.jewel_rl, actor=("room 1", 42)),
    loc_names.ccb_skel_hallway_ba:           CVLoDLocationData(0xF7, Scenes.CASTLE_CENTER_BASEMENT, item_names.sub_cross, actor=("room 1", 43)),
    loc_names.ccb_behemoth_l_ff:             CVLoDLocationData(0xF9, Scenes.CASTLE_CENTER_BASEMENT, item_names.jewel_rs, actor=("room 3", 31)),
    loc_names.ccb_behemoth_l_mf:             CVLoDLocationData(0xFA, Scenes.CASTLE_CENTER_BASEMENT, item_names.gold_300, actor=("room 3", 32)),
    loc_names.ccb_behemoth_l_mr:             CVLoDLocationData(0xFB, Scenes.CASTLE_CENTER_BASEMENT, item_names.jewel_rl, actor=("room 3", 25)),
    loc_names.ccb_behemoth_l_fr:             CVLoDLocationData(0xFC, Scenes.CASTLE_CENTER_BASEMENT, item_names.gold_500, actor=("room 3", 26)),
    loc_names.ccb_behemoth_r_ff:             CVLoDLocationData(0x100, Scenes.CASTLE_CENTER_BASEMENT, item_names.gold_300, actor=("room 3", 39)),
    loc_names.ccb_behemoth_r_mf:             CVLoDLocationData(0xFF, Scenes.CASTLE_CENTER_BASEMENT, item_names.jewel_rl, actor=("room 3", 28)),
    loc_names.ccb_behemoth_r_mr:             CVLoDLocationData(0xFE, Scenes.CASTLE_CENTER_BASEMENT, item_names.gold_500, actor=("room 3", 27)),
    loc_names.ccb_behemoth_r_fr:             CVLoDLocationData(0xFD, Scenes.CASTLE_CENTER_BASEMENT, item_names.jewel_rl, actor=("room 3", 26)),
    ...
    loc_names.ccbe_near_machine:             CVLoDLocationData(0x108, Scenes.CASTLE_CENTER_BOTTOM_ELEV, item_names.jewel_rs, actor=("proxy", 12)),
    loc_names.ccbe_atop_machine:             CVLoDLocationData(0x109, Scenes.CASTLE_CENTER_BOTTOM_ELEV, item_names.powerup, actor=("proxy", 8)),
    ...
    loc_names.ccbe_pipes:                    CVLoDLocationData(0x10A, Scenes.CASTLE_CENTER_BOTTOM_ELEV, item_names.gold_300, actor=("proxy", 14)),
    loc_names.ccbe_switch:                   CVLoDLocationData(0x10C, Scenes.CASTLE_CENTER_BOTTOM_ELEV, item_names.sub_holy, actor=("proxy", 17)),
    loc_names.ccbe_staircase:                CVLoDLocationData(0x10B, Scenes.CASTLE_CENTER_BOTTOM_ELEV, item_names.jewel_rl, actor=("proxy", 10)),
    loc_names.ccff_gears_side:               CVLoDLocationData(0x10E, Scenes.CASTLE_CENTER_FACTORY, item_names.jewel_rs, actor=("room 0", 40)),
    loc_names.ccff_gears_mid:                CVLoDLocationData(0x10F, Scenes.CASTLE_CENTER_FACTORY, item_names.use_purifying, actor=("room 0", 38)),
    loc_names.ccff_gears_corner:             CVLoDLocationData(0x110, Scenes.CASTLE_CENTER_FACTORY, item_names.use_chicken, actor=("room 0", 39)),
    loc_names.ccff_lizard_near_knight:       CVLoDLocationData(0x111, Scenes.CASTLE_CENTER_FACTORY, item_names.sub_axe, actor=("room 2", 38)),
    loc_names.ccff_lizard_pit:               CVLoDLocationData(0x112, Scenes.CASTLE_CENTER_FACTORY, item_names.use_card_s, actor=("room 2", 39)),
    loc_names.ccff_lizard_corner:            CVLoDLocationData(0x113, Scenes.CASTLE_CENTER_FACTORY, item_names.use_card_m, actor=("room 2", 40)),
    loc_names.ccff_lizard_locker_nfr:        CVLoDLocationData(0x117, Scenes.CASTLE_CENTER_FACTORY, item_names.jewel_rl, actor=("room 2", 44), type="liz"),
    loc_names.ccff_lizard_locker_nmr:        CVLoDLocationData(0x118, Scenes.CASTLE_CENTER_FACTORY, item_names.gold_500, actor=("room 2", 46), type="liz"),
    loc_names.ccff_lizard_locker_nml:        CVLoDLocationData(0x119, Scenes.CASTLE_CENTER_FACTORY, item_names.use_ampoule, actor=("room 2", 48), type="liz"),
    loc_names.ccff_lizard_locker_nfl:        CVLoDLocationData(0x11A, Scenes.CASTLE_CENTER_FACTORY, item_names.powerup, actor=("room 2", 50), type="liz"),
    loc_names.ccff_lizard_locker_fl:         CVLoDLocationData(0x11B, Scenes.CASTLE_CENTER_FACTORY, item_names.gold_500, actor=("room 2", 52), type="liz"),
    loc_names.ccff_lizard_locker_fr:         CVLoDLocationData(0x11C, Scenes.CASTLE_CENTER_FACTORY, item_names.use_card_s, actor=("room 2", 54), type="liz"),
    ...
    loc_names.ccb_mandrag_shelf_l:           CVLoDLocationData(0x345, Scenes.CASTLE_CENTER_BASEMENT, item_names.quest_mandragora, actor=("room 0", 15)),
    loc_names.ccb_mandrag_shelf_r:           CVLoDLocationData(0x346, Scenes.CASTLE_CENTER_BASEMENT, item_names.quest_mandragora, actor=("room 0", 14)),
    loc_names.ccb_torture_rack:              CVLoDLocationData(0x101, Scenes.CASTLE_CENTER_BASEMENT, item_names.use_purifying, actor=("room 0", 28)),
    loc_names.ccb_torture_rafters:           CVLoDLocationData(0x102, Scenes.CASTLE_CENTER_BASEMENT, item_names.use_beef, actor=("room 0", 31)),
    loc_names.ccll_brokenstairs_floor:       CVLoDLocationData(0x123, Scenes.CASTLE_CENTER_LIZARD_LAB, item_names.jewel_rl, actor=("room 0", 5)),
    loc_names.ccll_brokenstairs_save:        CVLoDLocationData(0x122, Scenes.CASTLE_CENTER_LIZARD_LAB, item_names.jewel_rl, actor=("room 0", 4)),
    loc_names.ccll_glassknight_l:            CVLoDLocationData(0x12A, Scenes.CASTLE_CENTER_LIZARD_LAB, item_names.jewel_rs, actor=("room 5", 15)),
    loc_names.ccll_glassknight_r:            CVLoDLocationData(0x12B, Scenes.CASTLE_CENTER_LIZARD_LAB, item_names.jewel_rs, actor=("room 5", 16)),
    loc_names.ccll_butlers_door:             CVLoDLocationData(0x125, Scenes.CASTLE_CENTER_LIZARD_LAB, item_names.jewel_rs, actor=("room 1", 13)),
    loc_names.ccll_butlers_side:             CVLoDLocationData(0x124, Scenes.CASTLE_CENTER_LIZARD_LAB, item_names.use_purifying, actor=("room 1", 10)),
    loc_names.ccll_cwhall_butlerflames_past: CVLoDLocationData(0x126, Scenes.CASTLE_CENTER_LIZARD_LAB, item_names.use_ampoule, actor=("room 2", 25)),
    loc_names.ccll_cwhall_flamethrower:      CVLoDLocationData(0x129, Scenes.CASTLE_CENTER_LIZARD_LAB, item_names.gold_500, actor=("room 2", 23)),
    loc_names.ccll_cwhall_cwflames:          CVLoDLocationData(0x127, Scenes.CASTLE_CENTER_LIZARD_LAB, item_names.use_chicken, actor=("room 2", 26)),
    loc_names.ccll_heinrich:                 CVLoDLocationData(0x284, Scenes.CASTLE_CENTER_LIZARD_LAB, item_names.quest_key_chbr, actor=("room 3", 13)),
    loc_names.ccia_nitro_crates:             CVLoDLocationData(0x13A, Scenes.CASTLE_CENTER_INVENTIONS, item_names.use_kit, actor=("room 4", 47)),
    loc_names.ccia_nitro_shelf_h:            CVLoDLocationData(0x347, Scenes.CASTLE_CENTER_INVENTIONS, item_names.quest_nitro, actor=("room 4", 3)),
    loc_names.ccia_stairs_knight:            CVLoDLocationData(0x13B, Scenes.CASTLE_CENTER_INVENTIONS, item_names.gold_500, actor=("room 0", 13)),
    loc_names.ccia_maids_vase:               CVLoDLocationData(0x135, Scenes.CASTLE_CENTER_INVENTIONS, item_names.jewel_rl, actor=("room 1", 29)),
    loc_names.ccia_maids_outer:              CVLoDLocationData(0x130, Scenes.CASTLE_CENTER_INVENTIONS, item_names.use_purifying, actor=("room 1", 31)),
    loc_names.ccia_maids_inner:              CVLoDLocationData(0x131, Scenes.CASTLE_CENTER_INVENTIONS, item_names.use_ampoule, actor=("room 1", 32)),
    loc_names.ccia_inventions_maids:         CVLoDLocationData(0x133, Scenes.CASTLE_CENTER_INVENTIONS, item_names.use_card_m, actor=("room 2", 26)),
    loc_names.ccia_inventions_crusher:       CVLoDLocationData(0x132, Scenes.CASTLE_CENTER_INVENTIONS, item_names.use_card_s, actor=("room 2", 25)),
    loc_names.ccia_inventions_famicart:      CVLoDLocationData(0x137, Scenes.CASTLE_CENTER_INVENTIONS, item_names.gold_500, actor=("room 2", 33)),
    loc_names.ccia_inventions_zeppelin:      CVLoDLocationData(0x2AA, Scenes.CASTLE_CENTER_INVENTIONS, item_names.use_beef, actor=("room 2", 31)),
    loc_names.ccia_inventions_round:         CVLoDLocationData(0x138, Scenes.CASTLE_CENTER_INVENTIONS, item_names.use_beef, actor=("room 2", 35)),
    loc_names.ccia_nitrohall_flamethrower:   CVLoDLocationData(0x139, Scenes.CASTLE_CENTER_INVENTIONS, item_names.jewel_rl, actor=("room 4", 45)),
    loc_names.ccia_nitrohall_torch:          CVLoDLocationData(0x134, Scenes.CASTLE_CENTER_INVENTIONS, item_names.use_chicken, actor=("room 4", 43)),
    loc_names.ccia_nitro_shelf_i:            CVLoDLocationData(0x348, Scenes.CASTLE_CENTER_INVENTIONS, item_names.quest_nitro, actor=("room 4", 6)),
    loc_names.ccll_cwhall_wall:              CVLoDLocationData(0x128, Scenes.CASTLE_CENTER_LIZARD_LAB, item_names.use_beef, actor=("room 2", 27)),
    loc_names.ccl_bookcase:                  CVLoDLocationData(0x13E, Scenes.CASTLE_CENTER_LIBRARY, item_names.use_card_s, actor=("room 0", 15)),
