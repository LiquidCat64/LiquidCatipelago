...
CVLOD_LOCATIONS_INFO = {
    # Foggy Lake
    loc_names.fld_forecast_port:            CVLoDLocationData(0x150, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.gold_500),
    loc_names.fld_forecast_starboard:       CVLoDLocationData(0x14F, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.jewel_rl),
    loc_names.fld_foremast_lower:           CVLoDLocationData(0x152, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.jewel_rl),
    loc_names.fld_stairs_port:              CVLoDLocationData(0x146, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.jewel_rs),
    loc_names.fld_stairs_starboard:         CVLoDLocationData(0x148, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.jewel_rs),
    loc_names.fld_net_port:                 CVLoDLocationData(0x14C, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.jewel_rs),
    loc_names.fld_net_starboard:            CVLoDLocationData(0x147, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.jewel_rs),
    loc_names.fld_mainmast_base:            CVLoDLocationData(0x142, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.sub_knife),
    loc_names.fld_near_door:                CVLoDLocationData(0x149, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.jewel_rs),
    loc_names.fld_near_block_l:             CVLoDLocationData(0x14B, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.gold_100),
    loc_names.fld_near_block_r:             CVLoDLocationData(0x14A, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.jewel_rl),
    loc_names.fld_above_door:               CVLoDLocationData(0x143, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.jewel_rl),
    loc_names.fld_stern_port:               CVLoDLocationData(0x145, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.jewel_rs),
    loc_names.fld_stern_starboard:          CVLoDLocationData(0x144, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.jewel_rs),
    loc_names.fld_poop_port_crates:         CVLoDLocationData(0x140, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.powerup),
    loc_names.fld_poop_starboard_crates:    CVLoDLocationData(0x141, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.jewel_rl),
    loc_names.fld_mainmast_top:             CVLoDLocationData(0x151, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.use_chicken),
    loc_names.fld_jiggermast:               CVLoDLocationData(0x27C, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.quest_key_deck),
    loc_names.fld_foremast_upper_port:      CVLoDLocationData(0x14D, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.use_beef),
    loc_names.fld_foremast_upper_starboard: CVLoDLocationData(0x14E, Scenes.FOGGY_LAKE_ABOVE_DECKS, item_names.sub_axe),
    loc_names.flb_hallway_l:                CVLoDLocationData(0x15A, Scenes.FOGGY_LAKE_BELOW_DECKS, item_names.gold_300),
    loc_names.flb_hallway_r:                CVLoDLocationData(0x15B, Scenes.FOGGY_LAKE_BELOW_DECKS, item_names.jewel_rs),
    loc_names.flb_tall_crates:              CVLoDLocationData(0x155, Scenes.FOGGY_LAKE_BELOW_DECKS, item_names.sub_knife),
    loc_names.flb_short_crates_l:           CVLoDLocationData(0x156, Scenes.FOGGY_LAKE_BELOW_DECKS, item_names.jewel_rl),
    loc_names.flb_short_crates_r:           CVLoDLocationData(0x157, Scenes.FOGGY_LAKE_BELOW_DECKS, item_names.gold_500),
    loc_names.flp_pier_l:                   CVLoDLocationData(0x162, Scenes.FOGGY_LAKE_PIER, item_names.use_chicken),
    loc_names.flp_pier_m:                   CVLoDLocationData(0x163, Scenes.FOGGY_LAKE_PIER, item_names.sub_axe),
    loc_names.flp_pier_r:                   CVLoDLocationData(0x164, Scenes.FOGGY_LAKE_PIER, item_names.jewel_rl),
    loc_names.flp_statue_l:                 CVLoDLocationData(0x161, Scenes.FOGGY_LAKE_PIER, item_names.use_beef),
    loc_names.flp_statue_r:                 CVLoDLocationData(0x160, Scenes.FOGGY_LAKE_PIER, item_names.use_chicken),

    # Forest of Silence
    loc_names.forest_pier_center:  CVLoDLocationData(0x16, Scenes.FOREST_OF_SILENCE, item_names.jewel_rs),
    loc_names.forest_pier_end:     CVLoDLocationData(0x17, Scenes.FOREST_OF_SILENCE, item_names.gold_300),
    loc_names.forest_sypha_ne:     CVLoDLocationData(0x19, Scenes.FOREST_OF_SILENCE, item_names.use_ampoule),
    loc_names.forest_sypha_se:     CVLoDLocationData(0x18, Scenes.FOREST_OF_SILENCE, item_names.jewel_rl),
    loc_names.forest_sypha_nw:     CVLoDLocationData(0x1A, Scenes.FOREST_OF_SILENCE, item_names.gold_500),
    loc_names.forest_sypha_sw:     CVLoDLocationData(0x1B, Scenes.FOREST_OF_SILENCE, item_names.use_purifying),
    loc_names.forest_flea_trail:   CVLoDLocationData(0x1C, Scenes.FOREST_OF_SILENCE, item_names.sub_axe),
    loc_names.forest_leap:         CVLoDLocationData(0x1E, Scenes.FOREST_OF_SILENCE, item_names.gold_500),
    loc_names.forest_descent:      CVLoDLocationData(0x1D, Scenes.FOREST_OF_SILENCE, item_names.powerup),
    loc_names.forest_tunnel:       CVLoDLocationData(0x21, Scenes.FOREST_OF_SILENCE, item_names.use_beef),
    loc_names.forest_child_ledge:  CVLoDLocationData(0x22, Scenes.FOREST_OF_SILENCE, item_names.gold_100),
    ...
    loc_names.forest_werewolf_pit: CVLoDLocationData(0x20, Scenes.FOREST_OF_SILENCE, item_names.sub_knife),
    loc_names.forest_pike:         CVLoDLocationData(0x27, Scenes.FOREST_OF_SILENCE, item_names.use_chicken),
    loc_names.forest_end_gate:     CVLoDLocationData(0x1F, Scenes.FOREST_OF_SILENCE, item_names.gold_500),
    loc_names.forest_skelly_mouth: CVLoDLocationData(0x23, Scenes.FOREST_OF_SILENCE, item_names.use_chicken),
    ...
    # Tunnel
    loc_names.tunnel_landing:               CVLoDLocationData(0xB6, Scenes.TUNNEL, item_names.jewel_rl),
    loc_names.tunnel_landing_rc:            CVLoDLocationData(0xB7, Scenes.TUNNEL, item_names.jewel_rs),
    loc_names.tunnel_stone_alcove_r:        CVLoDLocationData(0xCC, Scenes.TUNNEL, item_names.sub_holy),
    loc_names.tunnel_stone_alcove_l:        CVLoDLocationData(0xC5, Scenes.TUNNEL, item_names.use_beef),
    loc_names.tunnel_twin_arrows:           CVLoDLocationData(0xD3, Scenes.TUNNEL, item_names.use_ampoule),
    ...
    loc_names.tunnel_lonesome_bucket:       CVLoDLocationData(0xD6, Scenes.TUNNEL, item_names.use_ampoule),
    loc_names.tunnel_lbucket_mdoor_l:       CVLoDLocationData(0xCE, Scenes.TUNNEL, item_names.sub_knife),
    loc_names.tunnel_lbucket_quag:          CVLoDLocationData(0xBB, Scenes.TUNNEL, item_names.jewel_rl),
    ...
    loc_names.tunnel_lbucket_albert:        CVLoDLocationData(0xBC, Scenes.TUNNEL, item_names.jewel_rs),
    loc_names.tunnel_albert_camp:           CVLoDLocationData(0xBA, Scenes.TUNNEL, item_names.jewel_rs),
    loc_names.tunnel_albert_quag:           CVLoDLocationData(0xB9, Scenes.TUNNEL, item_names.jewel_rl),
    loc_names.tunnel_gondola_rc_sdoor_l:    CVLoDLocationData(0xCD, Scenes.TUNNEL, item_names.use_beef),
    loc_names.tunnel_gondola_rc_sdoor_m:    CVLoDLocationData(0xBE, Scenes.TUNNEL, item_names.use_beef),
    loc_names.tunnel_gondola_rc_sdoor_r:    CVLoDLocationData(0xBD, Scenes.TUNNEL, item_names.sub_cross),
    loc_names.tunnel_gondola_rc:            CVLoDLocationData(0xBF, Scenes.TUNNEL, item_names.powerup),
    loc_names.tunnel_rgondola_station:      CVLoDLocationData(0xB8, Scenes.TUNNEL, item_names.jewel_rs),
    loc_names.tunnel_gondola_transfer:      CVLoDLocationData(0xC7, Scenes.TUNNEL, item_names.gold_500),
    loc_names.tunnel_corpse_bucket_quag:    CVLoDLocationData(0xC0, Scenes.TUNNEL, item_names.jewel_rl),
    loc_names.tunnel_corpse_bucket_mdoor_l: CVLoDLocationData(0xCF, Scenes.TUNNEL, item_names.sub_holy),
    loc_names.tunnel_corpse_bucket_mdoor_r: CVLoDLocationData(0xC8, Scenes.TUNNEL, item_names.use_card_s),
    loc_names.tunnel_shovel_quag_start:     CVLoDLocationData(0xC1, Scenes.TUNNEL, item_names.jewel_rl),
    loc_names.tunnel_exit_quag_start:       CVLoDLocationData(0xC2, Scenes.TUNNEL, item_names.jewel_rl),
    loc_names.tunnel_shovel_quag_end:       CVLoDLocationData(0xC3, Scenes.TUNNEL, item_names.jewel_rl),
    loc_names.tunnel_exit_quag_end:         CVLoDLocationData(0xC9, Scenes.TUNNEL, item_names.gold_300),
    loc_names.tunnel_shovel:                CVLoDLocationData(0xD2, Scenes.TUNNEL, item_names.use_beef),
    loc_names.tunnel_shovel_save:           CVLoDLocationData(0xC4, Scenes.TUNNEL, item_names.jewel_rl),
    loc_names.tunnel_shovel_mdoor_c:        CVLoDLocationData(0x24, Scenes.TUNNEL, item_names.gold_100),
    loc_names.tunnel_shovel_mdoor_l:        CVLoDLocationData(0xCA, Scenes.TUNNEL, item_names.use_card_s),
    loc_names.tunnel_shovel_mdoor_r:        CVLoDLocationData(0xD0, Scenes.TUNNEL, item_names.sub_axe),
    loc_names.tunnel_shovel_sdoor_l:        CVLoDLocationData(0xCB, Scenes.TUNNEL, item_names.use_card_m),
    loc_names.tunnel_shovel_sdoor_m:        CVLoDLocationData(0xC6, Scenes.TUNNEL, item_names.use_chicken),
    loc_names.tunnel_shovel_sdoor_r:        CVLoDLocationData(0xD1, Scenes.TUNNEL, item_names.sub_cross),

    # Underground Waterway
    loc_names.uw_near_ent:         CVLoDLocationData(0xDC, Scenes.WATERWAY, item_names.gold_300),
    loc_names.uw_across_ent:       CVLoDLocationData(0xDD, Scenes.WATERWAY, item_names.gold_300),
    ...
    loc_names.uw_poison_parkour:   CVLoDLocationData(0xDE, Scenes.WATERWAY, item_names.use_ampoule),
    loc_names.uw_waterfall_ledge:  CVLoDLocationData(0xE2, Scenes.WATERWAY, item_names.gold_500),
    loc_names.uw_waterfall_child:  CVLoDLocationData(0x25, Scenes.WATERWAY, item_names.gold_100),
    loc_names.uw_carrie1:          CVLoDLocationData(0xDF, Scenes.WATERWAY, item_names.use_card_m, type="carrie"),
    loc_names.uw_carrie2:          CVLoDLocationData(0xE0, Scenes.WATERWAY, item_names.use_beef, type="carrie"),
    loc_names.uw_bricks_save:      CVLoDLocationData(0xE1, Scenes.WATERWAY, item_names.powerup),
    loc_names.uw_above_skel_ledge: CVLoDLocationData(0xE3, Scenes.WATERWAY, item_names.use_chicken),
    ...
    # The Outer Wall
    loc_names.towf_start_rear:           CVLoDLocationData(0x26A, Scenes.THE_OUTER_WALL, item_names.gold_500),
    loc_names.towf_start_front:          CVLoDLocationData(0x269, Scenes.THE_OUTER_WALL, item_names.jewel_rl),
    loc_names.towf_start_entry_l:        CVLoDLocationData(0x338, Scenes.THE_OUTER_WALL, item_names.gold_100, type="empty"),
    loc_names.towf_start_entry_r:        CVLoDLocationData(0x339, Scenes.THE_OUTER_WALL, item_names.gold_100, type="empty"),
    loc_names.towf_start_climb_b:        CVLoDLocationData(0x267, Scenes.THE_OUTER_WALL, item_names.sub_axe),
    loc_names.towf_start_climb_t:        CVLoDLocationData(0x268, Scenes.THE_OUTER_WALL, item_names.jewel_rs),
    loc_names.towf_start_elevator_l:     CVLoDLocationData(0x33A, Scenes.THE_OUTER_WALL, item_names.gold_300, type="empty"),
    loc_names.towf_start_elevator_r:     CVLoDLocationData(0x33B, Scenes.THE_OUTER_WALL, item_names.gold_300, type="empty"),
    loc_names.towse_pillar_l:            CVLoDLocationData(0x26B, Scenes.THE_OUTER_WALL, item_names.jewel_rl),
    loc_names.towse_pillar_r:            CVLoDLocationData(0x26C, Scenes.THE_OUTER_WALL, item_names.gold_300),
    loc_names.towse_eagle:               CVLoDLocationData(0x266, Scenes.THE_OUTER_WALL, item_names.use_beef),
    loc_names.towse_saws_door_l:         CVLoDLocationData(0x26D, Scenes.THE_OUTER_WALL, item_names.use_card_s),
    loc_names.towse_saws_door_r:         CVLoDLocationData(0x26E, Scenes.THE_OUTER_WALL, item_names.sub_axe),
    loc_names.towse_child:               CVLoDLocationData(0x26, Scenes.THE_OUTER_WALL, item_names.gold_100),
    loc_names.towse_key_ledge:           CVLoDLocationData(0x26F, Scenes.THE_OUTER_WALL, item_names.jewel_rl),
    loc_names.towse_key_entry_l:         CVLoDLocationData(0x33C, Scenes.THE_OUTER_WALL, item_names.gold_500, type="empty"),
    loc_names.towse_key_entry_r:         CVLoDLocationData(0x33D, Scenes.THE_OUTER_WALL, item_names.gold_500, type="empty"),
    loc_names.towse_key_alcove:          CVLoDLocationData(0x285, Scenes.THE_OUTER_WALL, item_names.quest_key_wall),
    loc_names.towse_locked_door_l:       CVLoDLocationData(0x33E, Scenes.THE_OUTER_WALL, item_names.jewel_rs, type="empty"),
    loc_names.towse_locked_door_r:       CVLoDLocationData(0x33F, Scenes.THE_OUTER_WALL, item_names.jewel_rs, type="empty"),
    loc_names.towse_half_arch_under:     CVLoDLocationData(0x271, Scenes.THE_OUTER_WALL, item_names.gold_300),
    loc_names.towse_half_arch_between:   CVLoDLocationData(0x272, Scenes.THE_OUTER_WALL, item_names.jewel_rs),
    loc_names.towse_half_arch_secret:    CVLoDLocationData(0x270, Scenes.THE_OUTER_WALL, item_names.use_beef),
    loc_names.towf_retract_elevator_l:   CVLoDLocationData(0x340, Scenes.THE_OUTER_WALL, item_names.jewel_rl, type="empty"),
    loc_names.towf_retract_elevator_r:   CVLoDLocationData(0x341, Scenes.THE_OUTER_WALL, item_names.jewel_rl, type="empty"),
    loc_names.towf_retract_shimmy_start: CVLoDLocationData(0x273, Scenes.THE_OUTER_WALL, item_names.jewel_rs),
    loc_names.towf_retract_shimmy_mid:   CVLoDLocationData(0x274, Scenes.THE_OUTER_WALL, item_names.use_card_m),
    loc_names.towf_boulders_door_l:      CVLoDLocationData(0x275, Scenes.THE_OUTER_WALL, item_names.sub_cross),
    loc_names.towf_boulders_door_r:      CVLoDLocationData(0x276, Scenes.THE_OUTER_WALL, item_names.gold_300),
    loc_names.towh_boulders_elevator_l:  CVLoDLocationData(0x342, Scenes.THE_OUTER_WALL, item_names.jewel_rl, type="empty"),
    loc_names.towh_boulders_elevator_r:  CVLoDLocationData(0x343, Scenes.THE_OUTER_WALL, item_names.jewel_rl, type="empty"),
    loc_names.towh_near_boulders_exit:   CVLoDLocationData(0x277, Scenes.THE_OUTER_WALL, item_names.sub_axe),
    loc_names.towh_slide_start:          CVLoDLocationData(0x278, Scenes.THE_OUTER_WALL, item_names.jewel_rs),
    loc_names.towh_slide_first_u:        CVLoDLocationData(0x27A, Scenes.THE_OUTER_WALL, item_names.sub_cross),
    loc_names.towh_slide_first_l:        CVLoDLocationData(0x279, Scenes.THE_OUTER_WALL, item_names.use_chicken),
    loc_names.towh_slide_second:         CVLoDLocationData(0x27B, Scenes.THE_OUTER_WALL, item_names.jewel_rl),
