...
from .options import CVLoDOptions, SubWeaponShuffle, RenonFightCondition, VincentFightCondition, VillaState, \
    CastleWallState, ItemPoolDifficulty
...
CVLOD_LOCATIONS_INFO = {
    ...
    loc_names.fld_mainmast_top:             CVLoDLocationData(0x151, 0, item_names.use_chicken,
                                                              easy_item=item_names.use_beef,
                                                              hard_item=item_names.jewel_rl),
    ...
    loc_names.fld_foremast_upper_port:      CVLoDLocationData(0x14D, 0, item_names.use_beef,
                                                              easy_item=item_names.use_kit,
                                                              hard_item=item_names.use_chicken),
    loc_names.fld_foremast_upper_starboard: CVLoDLocationData(0x14E, 0, item_names.sub_axe,
                                                              hard_item=item_names.sub_holy),
    ...
    loc_names.flp_pier_m:                   CVLoDLocationData(0x163, 0, item_names.sub_axe,
                                                              hard_item=item_names.sub_knife),  # Normally nothing
    ...
    loc_names.forest_flea_trail:   CVLoDLocationData(0x1C, 1, item_names.sub_axe,
                                                     hard_item=item_names.sub_knife),
    ...
    loc_names.forest_werewolf_pit: CVLoDLocationData(0x20, 1, item_names.sub_knife,
                                                     easy_item=item_names.sub_cross),
    ...
    loc_names.cw_lrampart:       CVLoDLocationData(0x47,  2, item_names.use_card_m,
                                                   hard_item=item_names.gold_100),  # Normally nothing
    ...
    loc_names.villala_hallway_r:            CVLoDLocationData(0x81,   3, item_names.sub_axe,
                                                              hard_item=item_names.sub_knife),
    # Vincent normally gives Archives Key. However, his location is not always created, so we assign it instead to the
    # pot location that IS always created.
    ...
    loc_names.villala_slivingroom_table_r:  CVLoDLocationData(0x8B,   3, item_names.gold_300,
                                                              easy_item=item_names.gold_500,
                                                              hard_item=item_names.gold_100),
    # Mary normally gives Copper Key. However, her location is not always created, so we assign it instead to the
    # servant path location that IS always created.
    ...
    loc_names.villafo_serv_ent:             CVLoDLocationData(0x74,   3, item_names.use_chicken,
                                                              hard_item=item_names.use_card_s),
    ...
    loc_names.atm_sw_alcove_2:   CVLoDLocationData(0x22D, 7, item_names.jewel_rs,
                                                   easy_item=item_names.jewel_rl),
    loc_names.atm_sw_alcove_4:   CVLoDLocationData(0x22E, 7, item_names.gold_100,  # Normally nothing (on Hard)
                                                   easy_item=item_names.gold_300),
    ...
    # This middle item changes itself depending on your current inventory.
    # In this rando, the item it adds is simply the first item the game checks for.
    ...
    loc_names.torc_meat_l:      CVLoDLocationData(0x2AC, 8, item_names.use_beef,
                                                  hard_item=item_names.sub_cross),
    ...
    loc_names.torc_walkway_u:   CVLoDLocationData(0x21D, 8, item_names.gold_300,
                                                  easy_item=item_names.gold_500,
                                                  hard_item=item_names.gold_100),
    loc_names.torc_aries:       CVLoDLocationData(0x21E, 8, item_names.jewel_rs,   # Normally nothing (on Hard)
                                                  easy_item=item_names.jewel_rl),
    ...
    loc_names.ccb_behemoth_drop_leg_hl:      CVLoDLocationData(0x31E,  9, item_names.use_chicken),
    loc_names.ccb_behemoth_drop_leg_hr:      CVLoDLocationData(0x31F,  9, item_names.use_chicken),
    loc_names.ccb_behemoth_drop_abdomen:     CVLoDLocationData(0x320,  9, item_names.use_chicken),
    loc_names.ccb_behemoth_drop_thorax:      CVLoDLocationData(0x321,  9, item_names.use_beef),
    loc_names.ccb_behemoth_drop_leg_fl:      CVLoDLocationData(0x322,  9, item_names.use_chicken),
    loc_names.ccb_behemoth_drop_leg_fr:      CVLoDLocationData(0x323,  9, item_names.use_chicken),
    loc_names.ccb_behemoth_drop_head:        CVLoDLocationData(0x324,  9, item_names.use_chicken),
    ...
    loc_names.dt_slant_l:        CVLoDLocationData(0x24B, 10, item_names.gold_300,
                                                   easy_item=item_names.gold_500,
                                                   hard_item=item_names.gold_100),   # Normally nothing
    loc_names.dt_slant_r:        CVLoDLocationData(0x24A, 10, item_names.jewel_rs,   # Normally nothing (on Hard)
                                                   easy_item=item_names.jewel_rl),
    ...
    loc_names.toe_renon_r:          CVLoDLocationData(0x1C1, 11, item_names.use_card_s,
                                                      hard_item=item_names.use_card_m),
    ...
    loc_names.toscic_first:             CVLoDLocationData(0x1DC, 12, item_names.gold_300,
                                                          easy_item=item_names.gold_500,
                                                          hard_item=item_names.gold_100),
    # Yes, this is the ONE instance of a jewel being S on Normal and L on Easy AND Hard.
    # Why they nerfed it on Normal specifically but not on Hard is beyond me...
    loc_names.toscic_second:            CVLoDLocationData(0x1DB, 12, item_names.jewel_rs,
                                                          easy_item=item_names.jewel_rl,
                                                          hard_item=item_names.jewel_rl),
    loc_names.toscic_elevator:          CVLoDLocationData(0x1DA, 12, item_names.jewel_rs,   # Normally nothing (on Hard)
                                                          easy_item=item_names.jewel_rl),
    ...
    loc_names.toscit_sec_check_r:       CVLoDLocationData(0x1EB, 12, item_names.jewel_rs,  # Normally nothing (on Hard)
                                                          easy_item=item_names.jewel_rl),
    ...
    loc_names.toscit_course_d3_c:       CVLoDLocationData(0x1F6, 12, item_names.gold_300,
                                                          easy_item=item_names.gold_500,
                                                          hard_item=item_names.gold_100),
    loc_names.toscit_course_alcove:     CVLoDLocationData(0x1F5, 12, item_names.jewel_rs,  # Normally nothing (on Hard)
                                                          easy_item=item_names.jewel_rl),  # Normally nothing (on Hard)
    ...
    loc_names.toscit_ctrl_interface_rr: CVLoDLocationData(0x1F8, 12, item_names.use_card_s,
                                                          easy_item=item_names.use_purifying,
                                                          hard_item=item_names.gold_100),
    ...
    # Yes, these two have their item types flipped on Easy.
    ...
    loc_names.ctga_far_slab3:               CVLoDLocationData(0x2EF, 15, item_names.use_card_s,
                                                              easy_item=item_names.use_purifying,
                                                              hard_item=item_names.gold_100),  # Normally nothing
    loc_names.ctga_far_slab4:               CVLoDLocationData(0x2F0, 15, item_names.gold_100,  # Nothing (Normal + Easy)
                                                              easy_item=item_names.use_chicken),
    ...
    loc_names.ctf_walkway_end:              CVLoDLocationData(0x25E, 15, item_names.jewel_rs,
                                                              easy_item=item_names.jewel_rl,
                                                              hard_item=item_names.powerup),
    loc_names.ctf_engine_floor:             CVLoDLocationData(0x260, 15, item_names.jewel_rs,  # Normally nothing (Hard)
                                                              easy_item=item_names.jewel_rl),
    ...
    loc_names.ck_renon_se:    CVLoDLocationData(0x175, 16, item_names.jewel_rl,
                                                hard_item=item_names.jewel_rs),
    loc_names.ck_renon_nw:    CVLoDLocationData(0x178, 16, item_names.jewel_rl,
                                                hard_item=item_names.jewel_rs),
...
def get_locations_to_create(locations: list[str], options: CVLoDOptions) -> \
        tuple[dict[str, int | None], dict[str, str], dict[int, str]]:
    ...
    corresponding locked Items placed on them. This is also where the Locations with sub-weapons that should be shuffled
    independently of the rest of the Item pool are figured out."""
    locations_with_ids = {}
    locked_pairs = {}
    sub_weapon_shuffle_locs = {}
    ...
    for loc in locations:
        ...
        if loc in CVLOD_LOCATIONS_INFO:
            # Get the Item that should be on that Location normally so we can then check it to see if it's a sub-weapon
            # for the purposes of Own Pool Sub-weapon Shuffle.
            # If the Item Pool Difficulty is Hard and the Location has a Hard item defined for it, get that Item.
            if options.item_pool_difficulty == ItemPoolDifficulty.option_hard and CVLOD_LOCATIONS_INFO[loc].hard_item:
                item_on_loc = CVLOD_LOCATIONS_INFO[loc].hard_item
            # If the Item Pool Difficulty is Easy and the Location has an Easy item defined for it, get that Item.
            elif options.item_pool_difficulty == ItemPoolDifficulty.option_easy and CVLOD_LOCATIONS_INFO[loc].easy_item:
                item_on_loc = CVLOD_LOCATIONS_INFO[loc].easy_item
            # Otherwise, get the normal Item.
            else:
                item_on_loc = CVLOD_LOCATIONS_INFO[loc].normal_item

            # If the Item on the Location is a sub-weapon, and sub-weapons are not set to shuffle anywhere,
            # don't add it.
            if item_on_loc in [item_names.sub_knife, item_names.sub_holy, item_names.sub_axe, item_names.sub_cross] \
                    and options.sub_weapon_shuffle != SubWeaponShuffle.option_anywhere:
                # Add the Location ID to the list of sub-weapon IDs to shuffle if Sub Weapon Shuffle is set to Own Pool
                # and Permanent Sub Weapons is off.
                if options.sub_weapon_shuffle == SubWeaponShuffle.option_own_pool and not options.permanent_sub_weapons:
                    sub_weapon_shuffle_locs[CVLOD_LOCATIONS_INFO[loc].flag_id] = item_on_loc
                continue
    ...
    return locations_with_ids, locked_pairs, sub_weapon_shuffle_locs
