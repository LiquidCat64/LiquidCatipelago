...
location_info = {
    ...
    lname.cwr_top:           {"code": 0x30,  "offset": 0x77BDC3, "normal item": iname.chicken, "countdown": 2},
    lname.cw_dragon_sw:      {"code": 0x49,  "offset": 0x78163B, "normal item": iname.chicken, "countdown": 2},
    # lname.cw_boss:           {"event": iname.trophy, "add conds": ["boss"]},
    lname.cw_save_slab1:     {"code": 0x2B8, "offset": 0x7816B1, "normal item": iname.jewel_l,  "countdown": 2,
                              "add conds": ["3hb"]},
    lname.cw_save_slab2:     {"code": 0x2B9, "offset": 0x7816B3, "normal item": iname.jewel_l,  "countdown": 2,
                              "add conds": ["3hb"]},
    lname.cw_save_slab3:     {"code": 0x2BA, "offset": 0x7816B5, "normal item": iname.jewel_l,  "countdown": 2,
                              "add conds": ["3hb"]},
    lname.cw_save_slab4:     {"code": 0x2BB, "offset": 0x7816B7, "normal item": iname.jewel_l,  "countdown": 2,
                              "add conds": ["3hb"]},
    lname.cw_save_slab5:     {"code": 0x2BC, "offset": 0x7816B9, "normal item": iname.jewel_l,  "countdown": 2,
                              "add conds": ["3hb"]},
    lname.cw_rrampart:       {"code": 0x46,  "offset": 0x781647, "normal item": iname.gold_300,  "countdown": 2},
    lname.cw_lrampart:       {"code": 0x47,  "offset": 0x781617, "normal item": iname.m_card,  "countdown": 2},
    lname.cw_pillar:         {"code": 0x44,  "offset": 0x782755, "normal item": iname.powerup,  "countdown": 2},
    ...
    lname.cw_ground_right:   {"code": 0x4D,  "offset": 0x781683, "normal item": iname.axe,  "countdown": 2,
                              "add conds": ["sub"]},
    lname.cwl_bottom:        {"code": 0x2E,  "offset": 0x77BD9F, "normal item": iname.m_card,  "countdown": 2},
    lname.cwl_bridge:        {"code": 0x2F,  "offset": 0x77BDAB, "normal item": iname.beef,  "countdown": 2},
    lname.cw_drac_sw:        {"code": 0x4E,  "offset": 0x78169B, "normal item": iname.chicken,  "countdown": 2},
    lname.cw_drac_slab1:     {"code": 0x2BD, "offset": 0x7816D5, "normal item": iname.gold_300,  "countdown": 2,
                              "add conds": ["3hb"]},
    lname.cw_drac_slab2:     {"code": 0x2BE, "offset": 0x7816D7, "normal item": iname.gold_300,  "countdown": 2,
                              "add conds": ["3hb"]},
    lname.cw_drac_slab3:     {"code": 0x2BF, "offset": 0x7816D9, "normal item": iname.gold_300,  "countdown": 2,
                              "add conds": ["3hb"]},
    lname.cw_drac_slab4:     {"code": 0x2C0, "offset": 0x7816DB, "normal item": iname.gold_300,  "countdown": 2,
                              "add conds": ["3hb"]},
    lname.cw_drac_slab5:     {"code": 0x2C1, "offset": 0x7816DD, "normal item": iname.gold_300,  "countdown": 2,
                              "add conds": ["3hb"]},
    ...
    lname.villafy_outer_gate_r:         {"code": 0x63,  "offset": 0x784697, "normal item": iname.jewel_l,
                                         "countdown": 3},
    lname.villafy_inner_gate:           {"code": 0x60,  "offset": 0x785B8D, "normal item": iname.beef, "countdown": 3},
    lname.villafy_gate_marker:          {"code": 0x65,  "offset": 0x7846AF, "normal item": iname.powerup,
                                         "countdown": 3},
    lname.villafy_villa_marker:         {"code": 0x64,  "offset": 0x7846A3, "normal item": iname.beef, "countdown": 3},
    ...
    lname.villafy_fountain_mr:          {"code": 0x5A,  "offset": 0x785A6D, "normal item": iname.m_card,
                                         "countdown": 3},
    lname.villafy_fountain_rl:          {"code": 0x5C,  "offset": 0x785ACD, "normal item": iname.beef, "countdown": 3},
    ...
    lname.villafo_pot_r:                {"code": 0x6C,  "offset": 0x787E63, "normal item": iname.jewel_l,
                                         "countdown": 3},
    lname.villafo_sofa:                 {"code": 0x75,  "offset": 0x7892DD, "normal item": iname.purify,
