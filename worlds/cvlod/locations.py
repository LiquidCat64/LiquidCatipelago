...
CVLOD_LOCATIONS_INFO = {
    ...
    loc_names.ccia_nitro_shelf_h:            CVLoDLocationData(0x347, 18, item_names.quest_nitro),
    ...
    loc_names.ccia_nitro_shelf_i:            CVLoDLocationData(0x348, 18, item_names.quest_nitro),
    ...
    loc_names.tosor_super_1:  CVLoDLocationData(0x349, 13, item_names.gold_500),
    loc_names.tosor_super_2:  CVLoDLocationData(0x34A, 13, item_names.gold_500),
    loc_names.tosor_super_3:  CVLoDLocationData(0x34B, 13, item_names.use_kit),
