...
class Objects(IntEnum):
    ...
    SPECIAL_TEXT_SPOT = 0x18
    NITRO_MANDRAGORA_DISPLAY_SPOT = 0x19
    CASTLE_CENTER_TAKE_MANDRAGORA_SPOT = 0x1A
    CASTLE_CENTER_TAKE_NITRO_SPOT = 0x1B
    CASTLE_CENTER_CRACKED_WALL_SPOT = 0x1D
