...
region_info = {
    ...
    rname.dt_start: {"stage": rname.duel_tower,
                     # "locations": [lname.dt_boss_one],
                     "entrances": [ename.dt_start,
                                   ename.dt_drop]},

    rname.dt_main: {"stage": rname.duel_tower,
                    "locations": [lname.dt_pre_sweeper_l,
                                  lname.dt_pre_sweeper_r,
                                  # lname.dt_boss_two,
                                  lname.dt_werewolf_ledge,
                                  lname.dt_post_sweeper_l,
                                  lname.dt_post_sweeper_r,
                                  lname.dt_slant_l,
                                  lname.dt_slant_r,
                                  lname.dt_pinwheels_l,
                                  lname.dt_pinwheels_r,
                                  lname.dt_guards_l,
                                  lname.dt_guards_r,
                                  # lname.dt_boss_three,
                                  lname.dt_werebull_l,
                    ...
                    "entrances": [ename.dt_last]},

    rname.dt_end: {"stage": rname.duel_tower,
                   "entrances": [ename.dt_end]},

    rname.toe_main: {"stage": rname.tower_of_execution,
                     "locations": [lname.toem_start_l,
                                   lname.toem_start_r,
                                   lname.toem_spike_alcove_l,
                                   lname.toem_spike_alcove_r,
                                   lname.toem_spike_platform_l,
                                   lname.toem_spike_platform_r,
                                   lname.toes2_stones_l,
                                   lname.toes2_stones_r,
                                   lname.toes2_walkway,
                                   lname.toes1_grates_platform,
                                   lname.toes1_grates_alcove_l,
                                   lname.toes1_grates_alcove_r,
                                   lname.toes1_balls_l,
                                   lname.toes1_balls_r,
                                   lname.toes1_balls_corner,
                                   lname.toem_renon_l,
                                   lname.toem_renon_r,
                                   lname.toem_knights,
                                   lname.toem_first_pillar,
                                   lname.toem_last_pillar,
                                   lname.toem_tower,
                                   lname.toem_top_platform,
                                   lname.toes2_fort_save,
                                   lname.toes2_fort_ibridge,
                                   lname.toes2_fort_left,
                                   lname.toes2_fort_lookout,
                                   lname.toes2_punish_l,
                                   lname.toes2_punish_r,
                                   lname.toes2_punish_crack,
                                   lname.toes2_jails,
                                   lname.toes2_end_l,
                                   lname.toes2_end_r],
    ...
    rname.tosor_main: {"stage": rname.tower_of_sorcery,
                       "locations": [lname.tosor_electric,
                                     lname.tosor_lasers,
                                     lname.tosor_climb_l,
                                     lname.tosor_climb_r,
                                     lname.tosor_ibridge,
    ...
    rname.ct_start: {"stage": rname.clock_tower,
                     "locations": [lname.ctgc_gearclimb_battery_slab1,
                                   lname.ctgc_gearclimb_battery_slab2,
                                   lname.ctgc_gearclimb_battery_slab3,
                                   lname.ctgc_gearclimb_battery_slab4,
                                   lname.ctgc_gearclimb_battery_slab5,
                                   lname.ctgc_gearclimb_battery_slab6,
                                   lname.ctgc_gearclimb_corner_r,
                                   lname.ctgc_gearclimb_corner_f,
                                   lname.ctgc_gearclimb_door_slab1,
                                   lname.ctgc_gearclimb_door_slab2,
                                   lname.ctgc_gearclimb_door_slab3],
                     "entrances": [ename.ct_to_door_a]},

    rname.ct_bpillars: {"stage": rname.clock_tower,
                        "locations": [lname.ctgc_bp_chasm_fl,
                                      lname.ctgc_bp_chasm_fr,
                                      lname.ctgc_bp_chasm_rl,
                                      lname.ctgc_bp_chasm_k],
                        "entrances": [ename.ct_from_door_a,
                                      ename.ct_to_door_b]},

    rname.ct_abyss_near: {"stage": rname.clock_tower,
                          "locations": [lname.ctga_near_floor,
                                        lname.ctga_near_climb],
                          "entrances": [ename.ct_from_door_b,
                                        ename.ct_door_c,
                                        ename.ct_door_c_skip]},

    rname.ct_abyss_far: {"stage": rname.clock_tower,
                         "locations": [lname.ctga_far_slab1,
                                       lname.ctga_far_slab2,
                                       lname.ctga_far_slab3,
                                       lname.ctga_far_alcove],
                         "entrances": [ename.ct_to_door_d,
                                       ename.ct_door_c_reverse]},

    rname.ct_face: {"stage": rname.clock_tower,
                    "locations": [lname.ctw_clock,
                                  lname.ctw_walkway_end],
                    "entrances": [ename.ct_from_door_d,
                                  # ename.ct_renon
                                  ename.ct_door_e]},

    rname.ct_engine: {"stage": rname.clock_tower,
                      "locations": [lname.ctw_engine_floor,
                                    lname.ctw_engine_furnace,
                                    lname.ctw_pendulums_l,
                                    lname.ctw_pendulums_r,
                                    lname.ctw_slope_slab1,
                                    lname.ctw_slope_slab2,
                                    lname.ctw_slope_slab3,
                                    lname.ctw_walkway_mid],
                      "entrances": [ename.ct_end]},

    rname.ck_main: {"stage": rname.castle_keep,
                    "locations": [lname.ck_renon_sw,
                                  lname.ck_renon_se,
                                  lname.ck_renon_nw,
                                  lname.ck_renon_ne,
                                  # lname.ck_boss_one,
